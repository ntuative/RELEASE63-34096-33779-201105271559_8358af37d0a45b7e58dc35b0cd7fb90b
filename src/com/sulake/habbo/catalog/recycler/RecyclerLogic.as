package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_638 != const_1053;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1882 != RecyclerStatusMessageEvent.const_1281;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_638 == const_457;
      }
      ...
      {
         this.var_638 = const_1052;
         this.var_121 = new Array(const_204);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_204)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_638 = const_1053;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1876:
               this.var_638 = const_457;
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1245:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1753:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_121[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_204)
            {
               oldObjectData = this.var_121[newSlotId];
         ...
         this.var_121[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_121[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_121.length < const_204)
         {
            return false;
         }
         var _loc1_:int = 0;
