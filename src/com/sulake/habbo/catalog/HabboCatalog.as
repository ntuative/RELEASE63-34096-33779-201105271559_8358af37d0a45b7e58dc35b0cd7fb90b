package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_672:uint = 1;
      ...
      private var var_208:ChargeConfirmationDialog;
      ...
      private var var_2685:Boolean = true;
      
      private var var_1957:Boolean = false;
      
      private var var_2686:GiftWrappingConfiguration;
      
      private var var_1261:ClubGiftController;
      
      private var var_542:ClubBuyController;
      
      private var var_814:Map;
      
      private var var_1260:Boolean = false;
      
      private var var_813:IPurchasableOffer;
      
      private var var_1540:IDragAndDropDoneReceiver;
      
      private var var_61:PlacedObjectPurchaseData;
      
      private const const_1963:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1896);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_378.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_542.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_378.loadProductData(this);
      }
      ...
      {
         return this.var_378.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_378.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_66)
         {
            _loc3_ = this.var_378.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_814.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_672) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1963;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1957 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1261 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_542 == null)
         {
            this.var_542 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_812 && this.var_812 != "")
         {
            this.var_377.openPage(this.var_812);
            this.var_812 = "";
            this.var_1011 = -1;
         }
         else if(this.var_1011 > -1)
         {
            this.var_377.openPageById(this.var_1011,this.var_1956);
            this.var_1011 = -1;
            this.var_1956 = -1;
            this.var_812 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2684 && this._soundManager != null)
         {
         ...
         {
            this.var_208.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_70,this.var_109.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2685 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1221);
         }
         this.var_2685 = false;
         if(this.var_208 != null && !this.var_208.disposed)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1261.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2686 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_208 == null || this.var_208.disposed)
         {
            this.var_208 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_208.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_814.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_814.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1124 || !this.var_1124.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_191);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1260 && param1.type == RoomEngineObjectEvent.const_169)
         {
            this.resetPlacedOfferData(true);
            if(this.var_813 == null || this.var_813.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_813.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_61 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_813);
            _loc5_ = this.var_1540;
            if(_loc5_ != null)
            {
            ...
            if(this.var_61.roomCategory == this._roomEngine.activeRoomCategory && this.var_61.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_359:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_193);
                  ...
                  case FurniCategory.const_331:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_205);
                  ...
                  case FurniCategory.const_317:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_191);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_672);
            if(_loc1_ != null)
            {
