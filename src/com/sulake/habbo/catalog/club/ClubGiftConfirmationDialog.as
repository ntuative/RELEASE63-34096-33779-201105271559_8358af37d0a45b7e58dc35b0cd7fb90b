package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_98.productContainer)
         {
            return;
         }
         this.var_98.productContainer.view = _loc2_;
         this.var_98.productContainer.initProductIcon(this._controller.roomEngine);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_98.localizationId);
               break;
