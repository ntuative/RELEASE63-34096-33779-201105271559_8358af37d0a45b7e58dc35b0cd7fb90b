package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1013.removeEventListener(WindowKeyboardEvent.const_208,this.windowKeyEventProcessor);
            this.var_1013 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1013 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1013 != null)
         {
            this.var_1013.addEventListener(WindowKeyboardEvent.const_208,this.windowKeyEventProcessor);
         }
         return true;
      }
