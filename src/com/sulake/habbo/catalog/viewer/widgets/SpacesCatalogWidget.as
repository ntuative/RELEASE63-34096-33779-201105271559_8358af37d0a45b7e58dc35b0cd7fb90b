package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_232:String = "wallpaper";
      ...
      private var var_1630:String = "default";
      ...
      private var var_1631:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1088 = this.parseElements(_loc2_.floors.pattern);
         this.var_1351 = this.parseElements(_loc2_.walls.pattern);
         this.var_1349 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1088)
                  {
                     _loc11_ = this.var_1088[_loc10_];
                     if(this.var_703.indexOf(_loc10_) == -1)
                     {
                        this.var_703.push(_loc10_);
               ...
               case "wallpaper":
                  ...
                  break;
               case "landscape":
                  if(this.var_1349[_loc8_] != null)
                  {
                     this.var_875.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1630,this.var_1631,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1350[this.var_473];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1630);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1352[this.var_478];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_474];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1631);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_703[this.var_478];
         var _loc3_:Array = this.var_1088[_loc2_];
         if(_loc3_ != null && this.var_477 >= 0)
         {
            _loc11_ = _loc3_[this.var_477];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1352[this.var_478];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_876[this.var_473];
         var _loc6_:Array = this.var_1351[_loc5_];
         if(_loc6_ != null && this.var_476 >= 0)
         {
            _loc13_ = _loc6_[this.var_476];
            if(_loc13_ != null)
            {
               this.var_1630 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1350[this.var_473];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_875[this.var_474];
         var _loc9_:Array = this.var_1349[_loc8_];
         if(_loc9_ != null && this.var_475 >= 0)
         {
            _loc15_ = _loc9_[this.var_475];
            if(_loc15_ != null)
            {
               this.var_1631 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_474];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_114:
               ...
               if(this.var_478 < 0)
               {
                  this.var_478 = this.var_703.length - 1;
               }
               if(this.var_478 >= this.var_703.length)
               {
                  this.var_478 = 0;
               }
               this.var_477 = 0;
               this.var_1091 = 0;
               _loc5_ = this.var_703[this.var_478];
               _loc6_ = this.var_1088[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1091 = _loc6_.length;
               }
            ...
            case const_232:
               ...
               if(this.var_473 < 0)
               {
                  this.var_473 = this.var_876.length - 1;
               }
               if(this.var_473 == this.var_876.length)
               {
                  this.var_473 = 0;
               }
               this.var_476 = 0;
               this.var_1089 = 0;
               _loc7_ = this.var_876[this.var_473];
               _loc8_ = this.var_1351[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1089 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_474 < 0)
               {
                  this.var_474 = this.var_875.length - 1;
               }
               if(this.var_474 >= this.var_875.length)
               {
                  this.var_474 = 0;
               }
               this.var_475 = 0;
               this.var_1090 = 0;
               _loc9_ = this.var_875[this.var_474];
               _loc10_ = this.var_1349[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1090 = _loc10_.length;
               }
