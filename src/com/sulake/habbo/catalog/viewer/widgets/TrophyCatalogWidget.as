package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1453:int = 16763904;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_260.getWithIndex(this.var_304);
         if(_loc4_ != null)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_260.getWithIndex(this.var_304);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_304;
         if(this.var_304 >= this.var_260.length)
         {
            this.var_304 = 0;
         }
         var _loc2_:Map = this.var_260.getWithIndex(this.var_304);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_304 < 0)
         {
            this.var_304 = this.var_260.length - 1;
         }
         var _loc2_:Map = this.var_260.getWithIndex(this.var_304);
         if(_loc2_ != null)
         {
