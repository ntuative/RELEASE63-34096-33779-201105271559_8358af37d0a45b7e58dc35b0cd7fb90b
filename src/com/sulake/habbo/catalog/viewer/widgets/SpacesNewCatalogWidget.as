package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_418:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_418 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_418)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_418.numSelectables)
            {
               _loc3_ = this.var_418.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_107[this.var_512]);
      ...
      {
         var _loc2_:int = this.var_669[this.var_512];
         var _loc3_:Offer = this.var_204[this.var_512][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_479.numGridItems)
         {
            _loc2_ = this.var_204[this.var_512][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_669[this.var_512] = (this.var_204[this.var_512] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_669[0];
         var _loc2_:int = this.var_669[1];
         var _loc3_:int = this.var_669[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_382 || _loc1_.pricingModel == Offer.const_388))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_66 || _loc2_.productType == ProductTypeEnum.const_81))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_418.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_418.setSelected(this.var_418.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_479)
            {
               var_479.destroyGridItems();
            }
            page.replaceOffers(this.var_204[this.var_512],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_669[this.var_512];
