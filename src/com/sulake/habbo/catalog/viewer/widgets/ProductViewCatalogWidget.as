package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_981 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         this.var_1869 = new Point(this.var_89.x,this.var_89.y);
         ...
         this.var_1870 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_981.text = _loc4_;
         this.var_1230.text = _loc5_;
         this.var_981.height = this.var_981.textHeight + 5;
         this.var_1230.y = this.var_981.y + this.var_981.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_493:
                  _loc6_ = this.var_1870.clone();
                  if(this.var_525 != null)
                  {
                     this.var_525.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_525,this.var_1499,this.var_2111);
                     ...
                     case ProductTypeEnum.const_192:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_322,AvatarAction.const_621);
                              _loc16_.appendAction(AvatarAction.const_346,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2592)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2592 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_89 != null && true)
         {
            ...
            this.var_89.x = this.var_1869.x;
            this.var_89.y = this.var_1869.y;
            if(param3 != null)
            {
