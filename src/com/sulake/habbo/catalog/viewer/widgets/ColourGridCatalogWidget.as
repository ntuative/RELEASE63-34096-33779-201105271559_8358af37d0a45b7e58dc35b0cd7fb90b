package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1790 = _loc1_.content as XML;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_623 = _loc3_.content as BitmapData;
         ...
         this.var_899 = _loc5_.content as BitmapData;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_958.length,this.var_360.numGridItems]);
         this.var_360.destroyGridItems();
         this.var_220 = null;
         for each(_loc1_ in this.var_958)
         {
            if(_loc1_.length > 0)
            {
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1790) as IWindowContainer;
               ...
               if(_loc3_ != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_623.width,this.var_623.height,true,0);
                  _loc3_.bitmap.copyPixels(this.var_623,this.var_623.rect,new Point(0,0));
               }
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_899.width,this.var_899.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_899,this.var_899.rect,new Point(0,0),null,null,true);
