package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1954:String = "ctlg_";
      ...
      private var var_528:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_528 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_1954 + param1;
         ...
         this.var_2177 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2177) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1916:
               if(this.var_1235 == null)
               {
                  this.var_1235 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1235);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1911:
               ...
               break;
            case CatalogWidgetEnum.const_1723:
            ...
            case CatalogWidgetEnum.const_1769:
               ...
               break;
            case CatalogWidgetEnum.const_1895:
            ...
            case CatalogWidgetEnum.const_1775:
               ...
               break;
            case CatalogWidgetEnum.const_1695:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_528.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_528 != null)
         {
            return this.var_528.dispatchEvent(param1);
         }
         return false;
      }
