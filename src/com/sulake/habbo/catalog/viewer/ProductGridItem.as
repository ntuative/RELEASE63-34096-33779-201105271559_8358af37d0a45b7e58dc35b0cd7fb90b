package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1071:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_213:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_564:Object;
      ...
      {
         this._view.getChildByName(const_1071).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1071).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_87,MouseCursorType.const_730);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_730);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_213.select(this);
            this.var_564 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_564 != null && this.var_564 == param2)
         {
            _loc3_ = this.var_213.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_564 = null;
            }
