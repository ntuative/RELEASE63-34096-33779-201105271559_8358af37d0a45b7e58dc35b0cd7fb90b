package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1960:int = 0;
      
      private static const const_1010:int = 1;
      
      private static const const_1008:int = 2;
      
      private static const const_1006:int = 3;
      
      private static const const_1011:int = 42;
      
      private static const const_1007:int = 120;
      
      private static const const_1009:int = 4;
      ...
      private var var_72:FurniModel;
      
      private var var_858:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_346.add(FurniModelCategory.const_39,new FurniGridView(this.var_72,FurniModelCategory.const_39,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_346.add(FurniModelCategory.const_46,new FurniGridView(this.var_72,FurniModelCategory.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1009;
            _loc3_.y = _loc4_.y + const_1009;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_72.isTradingOpen;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         if(this.var_72.isMainViewActive())
         {
            this.var_72.resetUnseenItems();
         }
         switch(param1)
         {
            case FurniModelCategory.const_46:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_wall"));
               this.var_414 = FurniModelCategory.const_46;
               break;
            case FurniModelCategory.const_39:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_414 = FurniModelCategory.const_39;
               break;
            case FurniModelCategory.const_265:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_414 = FurniModelCategory.const_265;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_72.furniCategorySwitch();
         this.showCategoryGrid(this.var_414);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_346.getValue(this.var_414);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_72.getCategoryContent(this.var_414);
         if(!this.var_72.isListInited())
         {
            _loc2_ = const_1010;
         }
         ...
         if(this.var_2300 == _loc2_)
         {
            return;
         }
         this.var_2300 = _loc2_;
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_346.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_346.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_346.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_72.getUnseenItemCount(UnseenItemCategoryEnum.const_438) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_72.getUnseenItemCount(UnseenItemCategoryEnum.const_395) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_72.petsModel.getUnseenItemCount() > 0;
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_72.getSelectedItemIndex();
         _loc4_ = this.var_72.getGroupItemInIndex(_loc3_,this.var_414);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_191);
            ...
            {
               if(_loc5_.category == FurniCategory.const_211)
               {
         ...
         var _loc12_:Boolean = this.var_72.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_72.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_72.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_858 && this.var_858.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1007)
         {
            _loc3_ = const_1007;
         }
         else if(_loc3_ < const_1011)
         {
            _loc3_ = const_1011;
         }
         else
      ...
      {
         var _loc3_:GroupItem = this.var_72.getGroupItemInIndex(this.var_72.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_72.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_72.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_72.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_72.requestCatalogOpen();
                  break;
               default:
                  this.var_72.cancelFurniInMover();
            }
         }
         else if(param1.type == WindowEvent.const_50)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_265);
            }
         }
      }
