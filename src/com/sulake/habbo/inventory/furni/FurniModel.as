package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1643:int = 1000;
      ...
      private var var_2119:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_472 = [];
         this.var_471 = [];
         this.var_701 = new Timer(const_1642,1);
         this.var_701.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2936 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_701.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_701.stop();
               this.var_701 = null;
            }
            if(this.var_218 != null)
            {
               this.var_218.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_218.stop();
               this.var_218 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               if(this.var_2119 == null)
               {
                  this.var_2119 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2119;
            }
            else
            {
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_72);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_873 == null)
         {
            this.var_873 = this._windowManager.buildFromXML(this.var_2936) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_873.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_873.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_218 = new Timer(param1,1);
            this.var_218.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_218.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_72 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_265:
                  this._controller.toggleInventoryPage(InventoryCategory.const_128);
            }
         }
      }
      ...
      {
         this.var_2935 = getTimer();
         this.switchCategory(const_265);
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_700.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_211)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_265)
            {
      ...
      {
         return getTimer() < this.var_2935 + const_1643;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_359 || _loc3_.category == FurniCategory.const_331 || _loc3_.category == FurniCategory.const_317)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_717)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function updateView() : void
      {
         if(this._view != null)
         {
            this.method_7(const_39);
            this.method_7(const_46);
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_438:
               return this.var_472.length;
            case UnseenItemCategoryEnum.const_395:
               return this.var_471.length;
            default:
               return this.var_472.length + this.var_471.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_46:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_395));
                  this.var_471 = [];
            ...
            case const_39:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_438));
                  this.var_472 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
