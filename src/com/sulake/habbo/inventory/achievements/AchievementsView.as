package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_72:AchievementsModel;
      ...
      public function updateList() : void
      {
         ...
         var _loc1_:Array = this.var_72.getAchievements();
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_451.running);
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_754[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_378.getBadgeImage(param2.badgeId);
            this.var_754[param2.badgeId] = _loc4_;
         }
