package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_72:BadgesModel;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_640 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_640.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_640.scrollV;
         this.var_640.removeGridItems();
         this.var_990.removeGridItems();
         var _loc2_:Array = this.var_72.getBadges(BadgesModel.const_524);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_640.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_640.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_72.getBadges(BadgesModel.const_355);
         _loc4_ = 0;
      ...
      public function updateActionView() : void
      {
         ...
         var _loc2_:Badge = this.var_72.getSelectedBadge();
         if(_loc2_ == null)
         {
            _loc1_.disable();
         ...
         else
         {
            ...
            this.setBadgeName(this.var_72.controller.localization.getBadgeName(_loc2_.type));
            this.setBadgeDescriptionText(this.var_72.controller.localization.getBadgeDesc(_loc2_.type));
            this.setBadgeDescriptionImage(_loc2_.iconImage);
            _loc3_ = this.var_72.getBadges(BadgesModel.const_355);
            if(_loc3_ != null && _loc3_.length >= this.var_72.getMaxActiveCount() && !_loc2_.isInUse)
            {
               _loc1_.disable();
            }
            else
      ...
      {
         var _loc2_:int = this.var_640.getGridItemIndex(param1.window);
         var _loc3_:Badge = this.var_72.getBadgeFromInactive(_loc2_);
         if(_loc3_ != null)
         {
            this.var_72.setBadgeSelected(_loc3_.type);
         }
      }
      ...
      private function onActiveBadgeClick(param1:WindowEvent) : void
      {
         ...
         var _loc3_:Badge = this.var_72.getBadgeFromActive(_loc2_);
         if(_loc3_ != null)
         {
            this.var_72.setBadgeSelected(_loc3_.type);
         }
      ...
      private function onWearBadgeClick(param1:WindowEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_72.toggleBadgeWearing(_loc2_.type);
         }
      }
   }
}
