package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2261:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_378 = param5;
         this.var_378.events.addEventListener(BadgeImageReadyEvent.const_113,this.onBadgeImageReady);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1316.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_679.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_378.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_241.unshift(_loc11_);
            }
            else
            {
               this.var_241.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_241.length)
         {
            _loc3_ = this.var_241[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_524);
      ...
      {
         return this.getItemInIndex(param1,const_524);
      }
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_679.indexOf(_loc2_) == -1)
            {
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_679 && this.var_679.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1270));
            this.var_679 = [];
