package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2644:IWindowContainer;
      ...
      private const const_1963:Point = new Point(120,150);
      ...
      {
         return !!this.var_17 ? Boolean(this.var_17.getStateFlag(WindowState.const_84)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_799);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_372 != null && this.var_372 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_372 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_799);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_72:
               ...
               break;
            case InventoryCategory.const_128:
               this._controller.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_274:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_372);
         }
         ...
         _loc2_.container.removeChild(this.var_1914);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_372 == InventoryCategory.const_128)
            {
               this.toggleCategoryView(InventoryCategory.const_128);
            }
            else if(this.var_372 == InventoryCategory.const_72)
            {
               this.toggleCategoryView(InventoryCategory.const_72);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_72);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1913)
         {
            this.var_1913 = this.createCounter("badges");
         }
         var _loc1_:int = this._controller.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1913,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_1072;
            _loc3_.y = const_1072;
         }
         return _loc3_;
      }
