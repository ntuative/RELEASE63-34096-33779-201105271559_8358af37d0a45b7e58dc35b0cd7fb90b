package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         this.var_765 = new ThumbListManager(this._assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
      ...
      public function updateListViews() : void
      {
         ...
         var _loc4_:BitmapData = this.var_765.getListImage();
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:Effect = this.var_72.getSelectedEffect(-1);
         if(_loc3_ == null)
         {
            _loc1_.disable();
      ...
      private function activeThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc5_ = this.var_72.getItemInIndex(_loc4_,1);
            if(_loc5_ != null)
            {
               this.var_72.toggleEffectSelected(_loc5_.type);
            }
         }
      }
      ...
      private function inactiveThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc5_ = this.var_72.getItemInIndex(_loc4_,0);
            if(_loc5_ != null)
            {
               this.var_72.toggleEffectSelected(_loc5_.type);
            }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = this.var_72.getSelectedEffect(0);
               if(_loc3_ != null)
               {
                  this.var_72.requestEffectActivated(_loc3_.type);
               }
            }
         }
      }
