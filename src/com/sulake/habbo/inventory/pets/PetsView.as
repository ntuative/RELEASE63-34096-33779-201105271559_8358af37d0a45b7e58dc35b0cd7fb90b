package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1960:int = 0;
      
      private const const_1010:int = 1;
      
      private const const_1008:int = 2;
      
      private const const_1006:int = 3;
      ...
      private var var_72:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_213:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_213 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         var _loc2_:PetsGridItem = this.var_569.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_213.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_569 == null || this.var_569.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_569.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_569.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_72.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_213.addGridItem(_loc2_.window);
            this.var_569.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_213.removeGridItems();
         for each(_loc1_ in this.var_569)
         {
            _loc1_.dispose();
         }
         this.var_569.reset();
         _loc2_ = this.var_72.pets;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_72.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_50)
         {
            ...
            {
               case "tab_floor":
                  this.var_72.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
                  this.var_72.switchToFurnitureCategory(FurniModelCategory.const_46);
            }
            this.selectPetsTab();
         }
      }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Map = this.var_72.pets;
         if(!this.var_72.isListInitialized())
         {
            _loc2_ = this.const_1010;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1008;
         }
         else
         {
            _loc2_ = this.const_1006;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1010:
               ...
               break;
            case this.const_1008:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1006:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_72.roomSession != null)
         {
            _loc8_ = this.var_72.roomSession.arePetsAllowed;
            _loc9_ = this.var_72.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_72.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_438) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_72.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_395) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_72.getUnseenItemCount() > 0;
      }
   }
}
