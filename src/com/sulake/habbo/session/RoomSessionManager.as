package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         {
            this.gotoRoom(this.var_2711,this.var_2710,this.var_1967);
            this.var_1968 = false;
            this.var_1967 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_247,_loc7_));
         return true;
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1126:
                  break;
               case RoomSessionHandler.const_1214:
                  break;
               case RoomSessionHandler.const_963:
