package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1537:String = "sendAccessTokenToServer";
      
      private static const const_1536:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1537,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1536,this.jsFaceBookLogOutCallback);
