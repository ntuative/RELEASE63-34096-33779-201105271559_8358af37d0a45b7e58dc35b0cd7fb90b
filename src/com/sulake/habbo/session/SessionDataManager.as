package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_2998:Array;
      
      private var var_2020:GroupDetailsView;
      ...
      private var var_2021:UserTagManager;
      
      private var var_1296:BadgeImageManager;
      
      private var var_1294:HabboGroupInfoManager;
      ...
      private var var_1297:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_2998 = [];
         this.var_2021 = new UserTagManager(events);
         this.var_1294 = new HabboGroupInfoManager(this,events);
         this.var_1046 = new IgnoredUsersManager(this);
         this.var_1297 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_321)
         {
            this.var_321.removeEventListener(FurnitureDataParser.const_136,this.onFurnitureReady);
            this.var_321.dispose();
            this.var_321 = null;
         }
         if(this.var_672)
         {
            this.var_672.removeEventListener(ProductDataParser.const_136,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1296 = new BadgeImageManager(context.root.assets,events,this.var_195,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2021.communication = this._communication;
         this.var_1294.communication = this._communication;
         this.var_1297.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_321)
         {
            ...
            this.var_321 = new FurnitureDataParser(this.var_558,this._wallItems,this.var_557,this._localization);
            this.var_321.addEventListener(FurnitureDataParser.const_136,this.onFurnitureReady);
      ...
      private function onFurnitureReady(param1:Event = null) : void
      {
         var _loc2_:* = null;
         this.var_321.removeEventListener(FurnitureDataParser.const_136,this.onFurnitureReady);
         for each(_loc2_ in this.var_1045)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2235 = _loc2_.clubLevel;
         this.var_2023 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2544 = _loc3_.respectTotal;
         ...
         this.var_1922 = _loc3_.realName;
         this.var_2797 = _loc3_.identityId;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_666,this.var_1036));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2795 = _loc2_.isOpen;
         this.var_2796 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_2023 >= SecurityLevelEnum.const_1194;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2021.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1296.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1296.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_2020 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1294.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_2020.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1294.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1294.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1296.getBadgeImage(param1,BadgeImageManager.const_1339);
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_558.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_557.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1295.indexOf(param1) == -1)
         {
            this.var_1295.push(param1);
         }
         if(!this.var_195)
         {
            return false;
         ...
         if(this.var_672 == null)
         {
            ...
            this.var_672 = new ProductDataParser(_loc2_,this.var_1161);
            this.var_672.addEventListener(ProductDataParser.const_136,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_1045.indexOf(param1) == -1)
            {
               this.var_1045.push(param1);
            }
            return null;
         }
         var _loc2_:Array = this.var_558.getValues();
