package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_217:IHabboFriendList;
      ...
      private var var_469:FramerateTracker = null;
      
      private var var_284:LatencyTracker = null;
      
      private var var_697:LagWarningLogger = null;
      
      private var var_470:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_469 = new FramerateTracker();
         this.var_284 = new LatencyTracker();
         this.var_697 = new LagWarningLogger();
         this.var_470 = new ToolbarClickTracker(this);
         this.var_1617 = new Array(const_1115);
         var _loc4_:int = 0;
         while(_loc4_ < const_1115)
         {
            this.var_1617[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1699,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1669,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1704,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_912,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1131,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_217)
            {
               ...
               {
                  Component(this.var_217).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_217).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_217).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_217).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_217).events.removeEventListener(HabboFriendListTrackingEvent.const_590,this.onFriendlistTrackingEvent);
               }
               this.var_217.release(new IIDHabboFriendList());
               this.var_217 = null;
            }
            if(this.var_178)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_200,this.onRoomAdClick);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_195)
         {
            if(this.var_284 != null)
            {
               this.var_284.configuration = this.var_195;
            }
            if(this.var_285 != null)
            {
               this.var_285.configuration = this.var_195;
            }
            ...
            if(this.var_195)
            {
               ...
               {
                  this.var_697.configure(this.var_195);
               }
               if(this.var_469 != null)
               {
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._communication != null)
         {
            ...
            this._communication.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(this.method_12));
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_851,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_284 != null)
            {
               this.var_284.communication = this._communication;
               this.var_284.connection = param1;
            }
            if(this.var_697 != null)
            {
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_851)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1701);
         }
         else if(param1.type == HabboHotelViewEvent.const_614)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1742);
               break;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_195)
            {
               if(this.var_195.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1617)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1303);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1303,this.onCoreRunning);
         }
      }
      ...
      private function method_12(param1:HabboAchievementNotificationMessageEvent) : void
      {
      ...
      {
         this.var_217 = param2 as IHabboFriendList;
         Component(this.var_217).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_217).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_217).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_217).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_217).events.addEventListener(HabboFriendListTrackingEvent.const_590,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_590:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1131,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_912,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_200,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_315.events.addEventListener(AdEvent.const_601,this.onRoomAdLoad);
      }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_469)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_469.frameRate),_loc2_);
                  ++this.var_2106;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_470)
         {
            this.var_470.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_470)
         {
            this.var_470.track(param1.type);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_570 > -1 && _loc2_ < this.var_570)
         {
            ++this.var_2104;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2104);
         }
         if(this.var_570 > -1 && _loc2_ - this.var_570 > 15000)
         {
            ++this.var_2105;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2105);
         }
         this.var_570 = _loc2_;
         if(this.var_285 != null)
         {
            this.var_285.update(param1,this.var_570);
         }
         if(this.var_284 != null)
         {
            this.var_284.update(param1,this.var_570);
         }
         if(this.var_469 != null)
         {
            this.var_469.trackUpdate(param1,this,this.var_570);
         }
         if(this.var_697 != null)
         {
            this.var_697.update(this.var_570);
         }
      }
   }
}
