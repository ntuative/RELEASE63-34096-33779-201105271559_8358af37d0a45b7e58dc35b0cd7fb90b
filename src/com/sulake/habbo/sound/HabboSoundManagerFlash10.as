package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private var var_1578:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_753,this.onTraxLoadComplete);
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1292.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1044.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1044 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_195 == null || this._connection == null || this._roomEngine == null || this.var_235 != null)
         {
            return;
         }
         this.var_235 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_235.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1937,this.var_839));
         this.var_839 = -1;
         this.var_840 = null;
      }
      ...
      {
         this.var_926 = param1;
         this.var_235.updateVolume(this.var_926);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_670.getValue(param1) != null)
         {
            ...
            if(this.var_275.getValue(_loc2_) == null)
            {
               ...
               param1.extract(this.var_1578,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1578,_loc2_,TraxSample.const_1844,TraxSample.const_1703);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1293.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1561 && this.var_1293.length > 0)
            {
               _loc3_ = this.var_1293.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_670.length == 0 && this.var_839 != -1)
            {
               this.var_840.ready = true;
               _loc4_ = this.var_839;
               this.var_839 = -1;
               this.var_840 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_753,_loc4_));
               if(this.var_2791)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_840 == null && this.var_1292.length > 0)
         {
            _loc1_ = this.var_1292.getKey(0);
            _loc2_ = this.var_1292.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_753,_loc1_));
               }
               else
               {
                  this.var_840 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_235.samplesIdsInUse;
         var _loc4_:int = 0;
         ...
         if(_loc1_ > const_1563)
         {
            ...
            if(_loc7_.length > 0)
            {
               ...
               this.var_235.samplesUnloaded(_loc7_);
            }
         }
      }
