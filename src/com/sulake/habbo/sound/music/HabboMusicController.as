package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1547:int = HabboMusicPrioritiesEnum.const_135;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_730.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_730.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_730)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_913,this.onJukeboxInit);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_284,this.onJukeboxDispose);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_845,this.onSoundMachineInit);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_850,this.onSoundMachineDispose);
         this.var_1283 = new Timer(1000);
         this.var_1283.start();
         this.var_1283.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_286)
         {
            this.var_317[_loc6_] = null;
            this.var_827[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1990)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_396)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_272)
            {
               ...
               {
                  _loc3_ = this.var_272.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_913,this.onJukeboxInit);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_284,this.onJukeboxDispose);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_845,this.onSoundMachineInit);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_850,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_286)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_317[param1] = _loc7_;
         this.var_827[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_317[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_317[param1];
      ...
      {
         var _loc1_:int = this.var_317.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_317[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_272.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_286)
         {
      ...
      {
         if(this.var_658.getValue(param1) == null)
         {
            this.var_658.add(param1,param2);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_272.length)
         {
            ...
            if(_loc3_.id != this.var_1561 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_317[_loc2_] != null)
            {
               _loc3_ = this.var_317[_loc2_];
               _loc4_ = this.var_272.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_272.add(_loc6_.id,_loc10_);
               ...
               while(this.var_826.indexOf(_loc6_.id) != -1)
               {
                  this.var_826.splice(this.var_826.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_286)
         {
            return false;
         }
         ...
         this.var_1990 = this.getSongRequestCountAtPriority(param1);
         this.var_1561 = param2;
         if(this._priorityPlaying <= const_1547)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2746 != param1.id || _loc3_ > this.var_2745 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2746 = param1.id;
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            if(this.var_272.getValue(_loc6_) == null)
            {
               this.var_826.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_549 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_86,this._connection) as IPlayListController;
      }
