package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_235:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_235 = param2;
         this.var_730 = [];
         this.var_730.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_730.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_730)
         {
         ...
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_897,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_804,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_897,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_804,this.onSoundMachineStopEvent);
               this.var_86 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_424 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_235.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_424 = -1;
         this.var_613 = false;
         this.var_235.stop(HabboMusicPrioritiesEnum.const_135);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_235.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_235.playSong(param1,HabboMusicPrioritiesEnum.const_135,_loc3_,0,0,0))
         {
