package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1844:String = "sample_44khz";
      
      public static const const_1772:String = "sample_22khz";
      
      public static const const_1754:String = "sample_11khz";
      
      public static const const_1703:String = "sample_16bit";
      
      public static const const_1862:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1114:int = 32;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_174 * this.var_83;
         ...
         param1.position = 0;
         var _loc9_:int = 0;
         var _loc10_:int = _loc7_ / this.var_83;
         var _loc11_:int = 0;
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1114)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1114);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_174 == this.var_174 - 1)
            {
               this.var_129[int(_loc11_ / this.var_174)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_129.length * this.var_174 * this.var_83;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_174 * this.var_83;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
