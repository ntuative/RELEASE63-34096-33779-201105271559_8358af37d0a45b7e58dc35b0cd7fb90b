package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1048:Boolean = false;
      
      private static const const_666:String = "Navigation";
      
      private static const const_665:String = "Friend Bar";
      
      private static const const_1471:String = "go.friendbar";
      
      private static const const_1472:String = "chat_btn_click";
      
      private static const const_1469:String = "find_friends_btn_click";
      
      private static const const_1050:String = "Toolbar";
      
      private static const const_1049:String = "open";
      
      private static const const_1047:String = "close";
      
      private static const const_1473:String = "FRIENDLIST";
      ...
      private var var_437:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_437)
            {
               this.var_437.release(new IIDHabboMessenger());
               this.var_437 = null;
            }
            this.var_140 = null;
      ...
      {
         return this.var_305.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_666,const_665,const_1471));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_437)
         {
            this.var_437.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_87)
            {
               this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_666,const_665,const_1472));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_666,const_665,const_1469));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_306)
         {
            if(!this.var_306.disposed)
            {
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1050,const_1473,!!this.var_306.isOpen() ? const_1049 : const_1047));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_437)
         {
            ...
            {
               this.var_437.toggleMessenger();
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1050,const_1470,!!this.var_437.isOpen() ? const_1049 : const_1047));
               }
            }
         }
      }
      ...
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_87.addHabboConnectionMessageEvent(new FriendRoomEventEvent(this.onRoomEvent));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_437 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_305.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_305.remove(_loc8_);
               this.var_140.splice(this.var_140.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_305.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_300)
            {
               ...
               this.var_305.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_300)
            {
               if(this.var_305.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_140.push(_loc3_);
                  this.var_305.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_140 = !!const_300 ? this.sortByNameAndOnlineStatus(this.var_140) : this.sortByName(this.var_140);
         }
