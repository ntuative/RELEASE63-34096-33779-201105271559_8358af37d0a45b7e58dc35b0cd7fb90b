package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class TextCropper implements IDisposable
   {
      ...
      public function TextCropper()
      {
         ...
         this.var_1028 = this.var_548.defaultTextFormat;
      }
      ...
      public function crop(param1:ITextWindow) : void
      {
         ...
         this.var_548.setTextFormat(this.var_1028);
         this.var_548.text = param1.getLineText(0);
         var _loc2_:int = this.var_548.textWidth;
         if(_loc2_ > param1.width)
         {
            _loc3_ = this.var_548.getCharIndexAtPoint(param1.width - this.var_2992,this.var_548.textHeight / 2);
            param1.text = param1.text.slice(0,_loc3_) + this.var_2991;
         }
      }
   }
}
