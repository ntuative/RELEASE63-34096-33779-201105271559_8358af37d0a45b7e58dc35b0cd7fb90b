package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1981 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1279 = this.var_1981.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1279)
         {
            this.var_1279.procedure = this.onButtonClick;
         }
         this.var_1278 = this.var_1981.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1278)
         {
      ...
      {
         if(this.var_270 >= this.var_64.length - 1)
         {
         ...
         if(this.var_270 <= 0)
         {
            this.var_1279.disable();
         }
         else
         {
            this.var_1279.enable();
         }
      }
      ...
      {
         ++this.var_270;
         this.var_270 = Math.min(this.var_270,this.var_64.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_64[this.var_270][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_64[this.var_270][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_64[this.var_270][1]).value;
