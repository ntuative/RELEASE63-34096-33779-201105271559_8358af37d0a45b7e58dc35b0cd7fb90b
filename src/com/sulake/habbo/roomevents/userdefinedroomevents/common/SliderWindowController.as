package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_936);
         }
      ...
      {
         return int(this.var_1652 * (Number(param1 - this._minValue) / (this.var_1166 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1652 * (this.var_1166 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_937)
         {
            if(param1.type == WindowMouseEvent.const_54 || param1.type == WindowMouseEvent.const_197)
            {
               this.var_937 = false;
            }
         }
         if(!this.var_937 || param1.type != WindowEvent.const_426)
         {
            return;
         }
         if(this.var_607 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_607 != 0)
            {
               _loc3_ = this.var_936 + this.var_607;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_718 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_718.width,this.var_718.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_718,this.var_718.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1652 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_718 = BitmapData(_loc2_.content);
      }
   }
}
