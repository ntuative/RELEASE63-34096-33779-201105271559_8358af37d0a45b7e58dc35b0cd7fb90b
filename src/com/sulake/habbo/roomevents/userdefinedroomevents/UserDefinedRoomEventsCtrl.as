package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1481:int = 2;
      ...
      private var var_1827:TriggerConfs;
      
      private var var_1825:ActionTypes;
      
      private var var_1826:ConditionTypes;
      
      private var var_259:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_778:RoomObjectHightLighter;
      
      private var var_178:UserDefinedRoomEventsHelp;
      
      private var var_1216:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1827 = new TriggerConfs();
         this.var_1825 = new ActionTypes();
         this.var_1826 = new ConditionTypes();
         this.var_259 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_778 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1216 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_54,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_1216.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1216.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_778.hideAll(this.var_259);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_778.showAll(this.var_259);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1216.setValue(_loc6_);
         }
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_86.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_36.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_36 as TriggerDefinition != null)
         {
            this.var_86.send(new UpdateTriggerMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ActionDefinition != null)
         {
            this.var_86.send(new UpdateActionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ConditionDefinition != null)
         {
            this.var_86.send(new UpdateConditionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1216.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1481) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1481 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_86.send(new ApplySnapshotMessageComposer(this.var_36.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1827);
         this.refreshConfigureElement(this.var_1825);
         this.refreshConfigureElement(this.var_1826);
