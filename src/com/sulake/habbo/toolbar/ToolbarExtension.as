package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1599:uint = 12247545;
      
      private static const const_1600:String = "HELP";
      
      private static const const_1601:String = "ROOMINFO";
      ...
      private var var_389:IWindow;
      
      private var var_685:IWindowContainer;
      
      private const const_815:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_389 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_60.removeListItem(this.var_389);
      }
      
      public function showRoomInfo() : void
      {
         this.var_60.addListItemAt(this.var_389,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_907;
         _loc3_.y = this.const_815;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_685)
         {
            this.var_685 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1600);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1601);
               break;
            case "confirm":
               if(false)
               {
