package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_580:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1422);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_291.definition.geometryType);
         if(this.var_47 == null || _loc4_ != null && (this.var_47.width != _loc4_.width || this.var_47.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_291.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         switch(param1)
         {
            case AvatarAction.const_419:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1866:
                  case AvatarAction.const_1893:
                  case AvatarAction.const_1322:
                  case AvatarAction.const_1300:
                  case AvatarAction.const_1749:
                  case AvatarAction.const_1728:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_338.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_930);
         this.getCache().resetBodyPartCache(this.var_930);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1421 = this._structure.sortActions(this.var_338);
         ...
         {
            this.var_825 = this._structure.getCanvasOffsets(this.var_1421,this._scale,this.var_94);
         }
      }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1206 = _loc4_.id;
                     this.var_1719 = _loc4_.breed;
                     break;
                  }
               }
            }
