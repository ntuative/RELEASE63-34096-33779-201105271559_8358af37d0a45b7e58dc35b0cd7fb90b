package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1988:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1442:IAvatarImage;
      ...
      private var var_453:BitmapDataAsset;
      
      private var var_1019:BitmapData;
      
      private var var_2720:ByteArray;
      
      private var var_2721:ImageData;
      
      private var var_986:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_820 == GeometryType.const_1209 && param1 == GeometryType.const_1273 || this.var_820 == GeometryType.const_1273 && param1 == GeometryType.const_1209)
         {
            this.var_820 = param1;
            this.var_90 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_380.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_969)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_577)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1442.getFigure(),_loc5_,this.var_820,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_436 == null)
         {
            ...
            this.var_436 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_380);
            if(this.var_436 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_90)
         {
            this.var_90 = this._structure.getCanvas(this._scale,this.var_820);
            if(!this.var_90)
            {
               return null;
            }
            this.var_2722 = new Point(0,this.var_90.height - int(this.var_90.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1716[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_715 || _loc10_ == AvatarAction.const_425;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1548 = this.var_124.bodyPartId;
               this.var_189 = this.var_124.partType;
               this.var_1983 = this.var_124.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_124.flippedPartType != this.var_189)
                     {
                        this.var_189 = this.var_124.flippedPartType;
                     }
                  }
               }
               this.var_1547 = this._scale + "_" + this.var_124.action.assetPartDefinition + "_" + this.var_189 + "_" + this.var_1983 + "_" + _loc5_ + "_" + this._frame;
               this.var_453 = this._assets.getAssetByName(this.var_1547) as BitmapDataAsset;
               if(this.var_453 == null)
               {
                  this.var_1547 = this._scale + "_std_" + this.var_189 + "_" + this.var_1983 + "_" + _loc5_ + "_0";
                  this.var_453 = this._assets.getAssetByName(this.var_1547) as BitmapDataAsset;
               }
               if(!(!this.var_453 || !this.var_453.content))
               {
                  if(this.var_124.paletteMapId > -1)
                  {
                     this.var_986 = this._structure.renderManager.paletteManager.getPalette(this.var_124.paletteMapId);
                     if(this.var_986 != null)
                     {
                        this.var_1019 = this.var_453.content as BitmapData;
                        this.var_188 = new BitmapData(this.var_1019.width,this.var_1019.height);
                        this.var_2720 = this.var_986.colorize(this.var_1019.getPixels(this.var_1019.rect));
                        this.var_188.setPixels(this.var_188.rect,this.var_2720);
                     }
                     else
                     {
                        this.var_188 = (this.var_453.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1548 == AvatarBodyPartType.const_241 || this.var_1548 == AvatarBodyPartType.const_1794 || this.var_1548 == AvatarBodyPartType.const_1718) && this.var_124.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_188.colorTransform(this.var_188.rect,this.var_124.color.colorTransform);
                  }
                  if(this.var_124.isBlendable)
                  {
                     this.var_188.colorTransform(this.var_188.rect,this.var_124.blendTransform);
                  }
                  this.var_1018 = this.var_453.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_56)
                     {
                  ...
                  this.var_2721 = new ImageData(this.var_188,this.var_1018,_loc7_);
                  this.var_1020.push(this.var_2721);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_1020,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2722.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_56)
            {
         ...
         _loc8_ = this.var_1020.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1020.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
