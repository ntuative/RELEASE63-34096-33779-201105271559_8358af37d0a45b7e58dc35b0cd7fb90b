package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2264:String = "hd-99999-99999";
      ...
      private var var_326:PetDataManager;
      ...
      private var var_2059:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_336 = RenderMode.const_1756;
         ...
         this.var_111.add(AvatarType.const_127,_loc4_);
         ...
         this.var_326 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         ...
         this.var_326.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_326.init();
         this.var_861.init();
         _loc2_ = this.var_111.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_111.getValue(AvatarType.const_127) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1039)
         {
            if(this.var_2854 && this.var_2853 && this.var_2855)
            {
               this.var_1039 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_111.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_2059)
         {
            this.var_2059 = new AvatarFigureContainer(this.const_2264);
         }
         this.var_243.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2059,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc2_ in this.var_327.getKeys())
         {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_326.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1766)
         {
            _loc6_ = !this.var_326.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_326.createPetFigureString(param1,param2,param3);
         ...
         if(param5 != null)
         {
            ...
            this.var_327.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_326.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_111.getValue(AvatarType.const_55);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_327.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_327.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_111.getValue(AvatarType.const_127) as AvatarStructure;
      ...
      {
         return this.var_326 as IPetDataManager;
      }
