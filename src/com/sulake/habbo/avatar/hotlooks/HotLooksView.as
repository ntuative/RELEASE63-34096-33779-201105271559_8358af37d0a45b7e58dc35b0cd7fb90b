package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_72:HotLooksModel;
      ...
      public function init() : void
      {
         ...
         this.var_637 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_637.numGridItems > 0)
         {
            this.var_637.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_72 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_637.removeGridItems();
         for each(_loc2_ in this.var_72.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_637.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_637.getGridItemIndex(param2.parent);
            this.var_72.selectHotLook(_loc3_);
         }
      }
