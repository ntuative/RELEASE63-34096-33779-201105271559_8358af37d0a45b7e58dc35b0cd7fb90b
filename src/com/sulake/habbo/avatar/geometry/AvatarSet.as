   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         for each(_loc4_ in param1.avatarset)
         {
            ...
            this.var_1289[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_2008.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_2008.concat();
         for each(_loc3_ in this.var_1289)
         {
      ...
      public function get isMain() : Boolean
      {
         ...
         for each(_loc1_ in this.var_1289)
         {
            if(_loc1_.isMain)
            {
               return true;
