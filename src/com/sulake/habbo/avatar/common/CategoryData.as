package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2271:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_989 >= 0 && this._parts.length > this.var_989)
         {
            _loc2_ = this._parts[this.var_989];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      {
         return this._parts[this.var_989] as AvatarEditorGridPartItem;
      }
