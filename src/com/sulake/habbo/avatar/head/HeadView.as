   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_196,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_278,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_253,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_244,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_298,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_72 && var_154 == "")
         {
            var_72.switchCategory(FigureData.const_196);
         }
      }
