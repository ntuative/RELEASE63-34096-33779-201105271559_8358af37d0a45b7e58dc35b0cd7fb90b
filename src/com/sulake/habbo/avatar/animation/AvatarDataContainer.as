package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1831:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_860 = new ColorTransform(this.var_1831,this.var_1832,this.var_1828,this._alphaMultiplier);
         this.var_1123 = this.generatePaletteMapForGrayscale(this.var_2245,this.var_2244);
      }
      ...
      {
         return this.var_1123.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1123.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1123.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1123.getValue("alphas") as Array;
      }
