package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1392:String = "Default";
      
      private static const const_1393:int = 2;
      
      private static const const_1391:String = AvatarSetType.const_35;
      ...
      protected var var_291:IActiveActionData;
      
      protected var var_1104:Boolean;
      
      protected var var_825:Array;
      ...
      protected var var_580:IAvatarDataContainer;
      
      protected var var_338:Array;
      
      protected var var_47:BitmapData;
      
      private var var_930:IActiveActionData;
      ...
      private var var_2773:String = null;
      
      private var var_2771:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1391,const_1393);
         this.var_338 = new Array();
         this.var_930 = new ActiveActionData(AvatarAction.const_398);
         this.var_930.definition = this._structure.getActionDefinition(const_1392);
         this.resetActions();
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_274.length == 1 && this.var_94 == this.var_1896)
         {
            return this.var_94 + this.var_553 + this.var_665 % 4;
         }
         if(this.var_274.length == 2)
         {
      ...
      {
         if(param3 != this.var_2772 || param2 != this.var_2773 || param1 != this.var_2771)
         {
            this.var_2772 = param3;
            this.var_2773 = param2;
            this.var_2771 = param1;
            this.var_2011 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_291.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1370 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1370)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_291.definition.geometryType,this.var_94);
         this.var_47.lock();
         ...
         {
            if(this.var_580.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_580.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_291.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_291.definition.geometryType,this.var_94);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_338.push(new ActiveActionData(param1,param2,this.var_665));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_291 = this.var_930;
         this.var_291.definition = this.var_930.definition;
         this.resetBodyPartCache(this.var_930);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_553 = "";
         this.var_274 = this._structure.sortActions(this.var_338);
         if(this.var_274 == null)
         {
            this.var_825 = new Array(0,0,0);
            if(this.var_1291 != "")
            {
               _loc1_ = true;
               this.var_1291 = "";
         ...
         {
            this.var_825 = this._structure.getCanvasOffsets(this.var_274,this._scale,this.var_94);
            for each(_loc4_ in this.var_274)
            {
               this.var_553 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_346)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1572 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1572 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1291 != this.var_553)
            {
               _loc1_ = true;
               this.var_1291 = this.var_553;
            }
         }
         this.var_1420 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_274)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_931 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_206 = this.var_206.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1720 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_580 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_335 || _loc1_.actionType == AvatarAction.const_271 || _loc1_.actionType == AvatarAction.const_425)
               {
                  this.var_931 = true;
               }
            }
