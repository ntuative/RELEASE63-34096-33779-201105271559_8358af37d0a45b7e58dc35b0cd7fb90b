package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2166:int = 6710886;
      ...
      private var var_350:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1160 = [];
         this.var_1424 = [AvatarEditorFigureCategory.const_733,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_241,AvatarEditorFigureCategory.const_819,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_115];
         super();
         ...
         if(var_1358 == null)
         {
            ...
            var_1358 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1635 == null)
         {
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1424);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2372 = this.canChangeOutfit();
            this.var_419.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_350 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_350.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_350.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1160.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_350.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_350.numSelectables)
               {
                  this.var_350.getSelectableAt(_loc6_).x = this.var_350.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_350.setSelected(this.var_350.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1424;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1721 == AvatarEditorSideCategory.const_115 || this.var_2370))
         {
         ...
         this.setViewToCategory(this.var_369);
      }
      ...
      {
         if(this.var_1721 == AvatarEditorSideCategory.const_115)
         {
            this.var_2370 = false;
            this.setSideContent(AvatarEditorSideCategory.const_740);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_740:
               break;
            case AvatarEditorSideCategory.const_615:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_615);
               break;
            case AvatarEditorSideCategory.const_115:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_115);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_369 = param1;
         this.var_350.setSelected(this.var_350.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2371 = new Date().valueOf();
                  this.var_2372 = false;
                  this.var_419.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_504)
         {
            ...
            this.var_504 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_504.procedure = this.stripClubDialogEventProc;
            this.var_504.center();
         }
         else
         {
            this.var_504.visible = true;
            this.var_504.center();
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2371 > 5000;
      }
   }
}
