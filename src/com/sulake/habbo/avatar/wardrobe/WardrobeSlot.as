package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_666 && this.var_1576)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_92,this.var_1036,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_35,parseInt(FigureData.const_898));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1036 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_2014,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_666)
               {
                  this._controller.loadAvatarInEditor(this.var_666,this.var_1036,this._controller.clubMemberLevel);
               }
         }
      }
