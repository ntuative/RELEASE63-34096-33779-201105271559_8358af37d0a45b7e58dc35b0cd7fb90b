   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_245,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_72,FigureData.const_263,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_72 && var_154 == "")
         {
            var_72.switchCategory(FigureData.TROUSERS);
         }
      }
