package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_550:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_393:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_510,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_612,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_304,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1313 && this.var_1312 && this.var_1592;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_510,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_612,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_304,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_576:
               this.var_1592 = true;
               if(this.var_45 != null && this.var_45.id == const_550)
               {
                  this.showView(const_91);
               }
               break;
            case HabboHelpTutorialEvent.const_510:
               if(this.var_45 != null && this.var_45.id == const_380)
               {
                  this.var_2038 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_612:
               if(this.var_2038)
               {
                  this.var_2038 = false;
                  this.showView(const_91);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2622 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_342:
               ...
               if(this.var_393 == null)
               {
                  this.var_393 = new NameChangeView(this);
               }
               this.var_393.showMainView();
               this.prepareForTutorial();
               break;
            case const_380:
         ...
         this._window.height = _loc2_.height + this.var_2621;
         this._window.width = _loc2_.width + this.var_2622;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_342 || this.var_45.id == const_91))
         {
            this.showView(const_91);
         }
      }
      ...
      {
         this.var_1313 = true;
         if(this.var_45 != null && (this.var_45.id == const_380 || this.var_45.id == const_91))
         {
            this.showView(const_91);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_574)
         {
            this.var_1312 = true;
         ...
         {
            this.var_393.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_574)
         {
            this.var_393.checkedName = _loc2_.name;
         }
         else
         {
            this.var_393.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
