package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1665:uint = 11129827;
      ...
      private var var_1115:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1666 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_721)
         {
            this.var_721 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_721)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_722)
         {
            this.var_722 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_722)
            {
               return;
            }
            this._window.content.addChild(this.var_722);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_722.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_491;
         }
         this.showView(this.var_722);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_885:
            ...
            case ChangeUserNameResultMessageEvent.var_882:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_886:
               break;
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1097 || param1 == ChangeUserNameResultMessageEvent.var_1095)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1115 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1115.render(param3,_loc5_);
         var _loc7_:int = 0;
