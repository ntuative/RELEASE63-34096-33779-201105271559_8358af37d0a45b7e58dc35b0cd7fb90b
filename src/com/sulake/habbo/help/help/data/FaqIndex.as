package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_854 = new FaqCategory(-999,"${help.faq.title.urgent}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_172 != null)
         {
            ...
            {
               _loc2_ = this.var_172.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_172.getValue(param1);
         if(_loc4_ != null || !param3)
         {
            return _loc4_;
         }
         _loc4_ = new FaqCategory(param1,param2);
         this.var_172.add(param1,_loc4_);
         return _loc4_;
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         {
            _loc4_ = this.var_172.getWithIndex(_loc3_);
      ...
      {
         return this.var_172.length;
      }
      
      public function getCategoryByIndex(param1:int) : FaqCategory
      {
         if(param1 >= this.var_172.length)
         {
            return null;
         }
         return this.var_172.getWithIndex(param1);
      }
      ...
      public function getCategoryTitleArray() : Array
      {
         ...
         while(_loc3_ < this.var_172.length)
         {
            _loc2_ = this.var_172.getWithIndex(_loc3_);
            if(_loc2_ != null)
            {
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_172.length)
         {
            _loc3_ = this.var_172.getWithIndex(_loc2_);
