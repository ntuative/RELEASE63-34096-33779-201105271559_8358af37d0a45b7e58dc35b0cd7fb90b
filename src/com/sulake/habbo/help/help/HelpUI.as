package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1891:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105271554));
         this.var_122 = new Map();
         this.var_122.add(HabboHelpViewEnum.const_1838,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_219,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_494,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_336,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_272,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_437,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_910,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_254,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_122.add(HabboHelpViewEnum.const_1210,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_122.add(HabboHelpViewEnum.const_1205,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_799,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_122.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_122.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_1891)
         {
            this.var_531 = new Array();
         }
         else if(param2)
         {
            if(this.var_531.length == 0 || param1 != this.var_369)
            {
               this.var_531.push(this.var_369);
            }
         }
         this.var_369 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_369);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_254:
               ...
               break;
            case CallForHelpResultEnum.const_1149:
               this.showUI(HabboHelpViewEnum.const_1205);
               break;
            case CallForHelpResultEnum.const_1154:
               this.showUI(HabboHelpViewEnum.const_1210);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_122.getValue(HabboHelpViewEnum.const_219) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_576));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_122.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_122.getValue(this.var_369);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2622 = this._window.width - _loc3_.width;
         this.var_2621 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2621;
         this._window.width = _loc1_.width + this.var_2622;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_369 == HabboHelpViewEnum.const_219)
         {
            return;
         }
         if(this.var_642.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_642.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_642[1],this.var_642[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_642[0],this.var_642[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_369 == HabboHelpViewEnum.const_219 || this.var_531.length == 0)
         {
            return;
         }
         if(this.var_368 == null)
