package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1424:int = 8;
      
      private static const const_1422:int = 5;
      
      private static const const_1417:int = 6;
      
      private static const const_1423:int = 3;
      
      private static const const_1415:int = 2;
      
      private static const const_1031:int = 6;
      
      private static const const_1418:int = 180;
      
      private static const const_1419:int = 246;
      
      private static const const_1365:int = 45;
      
      private static const const_1421:Point = new Point(115,93);
      
      private static const const_1420:Point = new Point(72,1);
      
      private static const const_1032:int = 40;
      
      private static const const_1416:int = 20;
      
      private static const const_1414:int = 3;
      ...
      private var var_757:ProgressBar;
      
      private var var_1178:Matrix;
      
      private var var_1749:ColorMatrixFilter;
      ...
      private var var_758:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_451 = new Timer(100,1);
         this.var_451.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_756 = new Timer(2000,1);
         this.var_756.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_758 = new AchievementLevelUp(this._questEngine);
         this.var_1178 = new Matrix();
         this.var_1749 = this.createGrayscaleFilter();
         this.var_616[16] = 1;
         this.var_616[28] = 6;
         this.var_616[38] = 4;
         this.var_616[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_451)
         {
            this.var_451.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_451.reset();
            this.var_451 = null;
         }
         if(this.var_756)
         {
            this.var_756.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_756.reset();
            this.var_756 = null;
         }
         if(this.var_617)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1365;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_426.height = getLowestPoint(this.var_426);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_757.refresh(this.var_107.getProgress(),this.var_107.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_755.height = getLowestPoint(this.var_755);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         if(this._category == null)
         {
            this.var_944.visible = false;
            return;
         }
         this.var_944.visible = true;
         this.var_944.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category.code);
         ...
         this._questEngine.setupAchievementCategoryImage(this.var_944,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_425.findChildByName("achievement_name_txt").caption = this._questEngine.localization.getBadgeName(_loc1_);
         var _loc2_:String = this._questEngine.localization.getBadgeDesc(_loc1_);
         this.var_425.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         ...
         this._questEngine.refreshReward(!this.var_69.finalLevel,this.var_425,this.var_69.levelRewardPointType,this.var_69.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_425,this.var_69);
         this.var_617.refresh(this.var_69.currentPoints,this.var_69.scoreLimit,this.var_69.type * 10000 + this.var_69.level);
         this.var_617.visible = !this.var_69.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1416;
         this.var_426 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_944 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_755 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_425 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1445 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1179 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_617 = new ProgressBar(this._questEngine,this.var_425,const_1418,"achievements.details.progress",true,const_1421);
         this.var_757 = new ProgressBar(this._questEngine,this.var_1179,const_1419,"achievements.categories.totalprogress",true,const_1420);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_426.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_657);
         var _loc5_:* = _loc4_ < const_1423;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1424) * (param1 % const_657);
            _loc3_.y = (_loc3_.height + const_1422) * Math.floor(param1 / const_657) + const_1417;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_755.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1031);
         var _loc5_:* = _loc4_ < const_1415;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.y = _loc3_.height * _loc4_ + const_1414;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_426.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_426.getChildAt(_loc2_));
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_754[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_754[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1032 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1425) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1749);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1032 - _loc5_.height + this.getPositionFix(param2.type));
         ...
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1749);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_69 = this.var_1444;
         this.var_107.update(this.var_1444);
         this.var_1444 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_754[param1.badgeId] = param1.badgeImage;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_757.updateView();
         }
         if(this.var_758 != null)
         {
            this.var_758.update(param1);
         }
      }
      ...
      {
         return !!this.var_616[param1] ? int(this.var_616[param1]) : 0;
      }
