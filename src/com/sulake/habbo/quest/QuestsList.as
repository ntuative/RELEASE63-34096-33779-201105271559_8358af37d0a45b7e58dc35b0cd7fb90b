package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1638:int = 5;
      
      private static const const_1637:int = 10;
      
      private static const const_1640:int = 10;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_745 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_745.toggle();
         this.var_2087 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_60.spacing = const_1637;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1640;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1638;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1639;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2087 && !this.var_2086)
            {
               this.var_2087 = false;
