package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1365:int = 56;
      
      private static const const_641:int = 5;
      
      private static const const_1366:int = 5;
      
      private static const const_1363:int = 30;
      
      private static const const_998:Point = new Point(8,8);
      
      private static const const_1364:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_311 == null || this.var_311.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc9_.x = const_998.x;
            _loc9_.y = const_998.y;
         ...
         _loc2_.height = _loc2_.textHeight + const_1366;
         var _loc4_:int = _loc2_.height - _loc3_ + (!!_loc2_.visible ? 0 : const_1363);
         _loc2_.visible = true;
         var _loc5_:IRegionWindow = IRegionWindow(this._window.findChildByName("catalog_link_region"));
         var _loc6_:* = const_1364.indexOf(param1.type) > -1;
         _loc5_.y = _loc2_.y + _loc2_.height + const_641;
         var _loc7_:int = 0;
         if(_loc6_ && !_loc5_.visible)
         {
            _loc7_ = const_641 + _loc5_.height;
         }
         if(!_loc6_ && _loc5_.visible)
         {
            _loc7_ = -const_641 - _loc5_.height;
         ...
         this._window.height = _loc9_.height + const_1365;
