package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private var var_1286:QuestController;
      
      private var var_1033:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1286 = new QuestController(this);
         this.var_1033 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1555);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_378.events.removeEventListener(BadgeImageReadyEvent.const_113,this.var_1033.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_378.events.addEventListener(BadgeImageReadyEvent.const_113,this.var_1033.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1286.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1033.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1286.questTracker.isVisible();
      }
