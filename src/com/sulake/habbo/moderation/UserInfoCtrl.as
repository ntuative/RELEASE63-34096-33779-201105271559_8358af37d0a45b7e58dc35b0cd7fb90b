package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1070:int = 60;
      
      private static const const_1067:int = 3600;
      
      private static const const_1068:int = 86400;
      
      private static const const_1069:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1070) + " mins ago";
         }
         if(param1 < 2 * const_1068)
         {
            return Math.round(param1 / const_1067) + " hours ago";
         }
         if(param1 < 2 * const_1069)
         {
            return Math.round(param1 / const_1068) + " days ago";
         }
         return Math.round(param1 / const_1069) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1248.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1248.addChild(_loc1_);
            this.var_35.disableButton(this.var_35.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_35.disableButton(this.var_35.initMsg.method_3,_loc1_,"message_but");
            this.var_35.disableButton(this.var_35.initMsg.method_3 || this.var_35.initMsg.kickPermission || this.var_35.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1146,this._data.userId),this._callerFrame,this.var_1249,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1249,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1627),this._callerFrame,this.var_1249,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1627),this._callerFrame,this.var_1249,false,true);
      }
