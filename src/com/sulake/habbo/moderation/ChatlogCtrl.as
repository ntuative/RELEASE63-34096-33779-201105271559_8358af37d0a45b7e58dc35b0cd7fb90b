package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_957:Array = [];
      
      private static var var_1789:int = 1000;
      
      private static var var_956:Array = [];
      
      private static var var_1788:int = 200;
      ...
      private var var_1787:IMessageComposer;
      ...
      {
         this.var_773 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_774 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1787);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_957.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_774.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_957.length < var_1789)
         {
            ...
            param1.width = this.var_774.width;
            param1.height = this.var_774.height;
            var_957.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_956.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_773.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_956.length < var_1788)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_773.width;
            param1.height = this.var_773.height;
            var_956.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1786[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1468.getValue(param2.chatterName))
            {
               this.var_1468.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1468.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1467)
         {
