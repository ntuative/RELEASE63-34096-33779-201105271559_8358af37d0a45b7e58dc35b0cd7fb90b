package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1069:Array = [];
      
      private static var var_2060:int = 200;
      ...
      {
         this.var_862 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1069.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_862.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1069.length < var_2060)
         {
            ...
            param1.width = this.var_862.width;
            param1.height = this.var_862.height;
            var_1069.push(param1);
         }
         else
         {
            param1.dispose();
