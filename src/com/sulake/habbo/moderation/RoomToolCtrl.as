package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1398:ICheckBoxWindow;
      
      private var var_1397:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_349));
         Logger.log("BEGINNING TO SHOW: " + this.var_349);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_349);
         if(param1.flatId != this.var_349)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_349);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1398 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1397 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_975,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1875,_loc2_,this.var_571.text,"",""));
         if(this.var_1398.isSelected || this.var_1397.isSelected || this.var_910.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1398.isSelected,this.var_1397.isSelected,this.var_910.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1714);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1842);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1125.selection];
         if(_loc3_ != null)
         {
            this.var_639 = false;
