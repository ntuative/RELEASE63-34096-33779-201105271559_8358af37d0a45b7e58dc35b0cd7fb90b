package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_235:IHabboMusicController;
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_235.events.addEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_235.events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_113,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_113,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_660.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_660.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_235 != null)
         {
            this.var_235.events.removeEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_235.events.removeEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
            this.var_235 = null;
         }
         this.var_1104 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_502);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_751);
         _loc1_.push(RoomWidgetFurniActionMessage.const_817);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1325);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_890);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_943);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_927);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1687);
         _loc1_.push(RoomWidgetPetCommandMessage.const_497);
         _loc1_.push(RoomWidgetPetCommandMessage.const_946);
         _loc1_.push(RoomWidgetUserActionMessage.const_588);
         _loc1_.push(RoomWidgetUserActionMessage.const_412);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_808);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_503)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_412 || param1.type == RoomWidgetUserActionMessage.const_588 || param1.type == RoomWidgetUserActionMessage.const_626)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_502:
            ...
            case RoomWidgetUserActionMessage.const_563:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1353,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_412:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_890:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_943:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_927:
            ...
            case RoomWidgetUserActionMessage.const_535:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_946:
            ...
            case RoomWidgetPetCommandMessage.const_497:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_808:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_281);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_400) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_400);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_825) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1240;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_281);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1129);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  {
                     _loc30_ = this.var_235.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_387) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_387.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_235.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_212)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_552)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_581);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_163)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_915);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_694;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_783;
                  }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_660.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_660.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_915);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_235 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_235.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_235 != null)
         {
            _loc2_ = this.var_235.getSongInfo(param1.id);
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_408,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
