package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1321);
               break;
            case RoomWidgetRoomQueueMessage.const_758:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1162);
               break;
            case RoomWidgetRoomQueueMessage.const_786:
               if(this._container.catalog != null)
               {
                  this._container.catalog.openCatalogPage(CatalogPageName.const_202,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_594];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_594:
               ...
               {
                  case RoomSessionQueueEvent.const_1162:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1321:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1721) + 1;
                  }
               }
               else
               {
