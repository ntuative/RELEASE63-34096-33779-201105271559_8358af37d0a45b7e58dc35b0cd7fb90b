package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_971);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_689);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_971:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_689:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_165);
         _loc1_.push(FriendRequestEvent.const_61);
         _loc1_.push(FriendRequestEvent.const_308);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_165:
            ...
            case FriendRequestEvent.const_308:
