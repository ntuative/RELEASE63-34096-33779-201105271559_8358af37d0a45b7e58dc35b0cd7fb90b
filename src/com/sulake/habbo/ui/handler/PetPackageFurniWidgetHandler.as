package com.sulake.habbo.ui.handler
{
   ...
   public class PetPackageFurniWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IPetDataListener, IGetImageListener
   {
      ...
      {
         return [RoomWidgetOpenPetPackageMessage.const_810];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetOpenPetPackageMessage.const_810:
      ...
      {
         return [RoomSessionPetPackageEvent.const_572,RoomSessionPetPackageEvent.const_506];
      }
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPetPackageEvent.const_572:
                  ...
                  this.var_1206 = _loc2_.petType;
                  this.var_1719 = _loc2_.breed;
                  this._color = _loc2_.color;
                  _loc4_ = this._container.avatarRenderManager.petDataManager.getPetData(this.var_1206,this);
                  _loc5_ = this.getPetImage();
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_603,this.var_222,_loc5_,-1,null);
               ...
               case RoomSessionPetPackageEvent.const_506:
                  ...
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_616,this.var_222,null,_loc6_,_loc7_);
                  this._container.events.dispatchEvent(_loc3_);
            }
         }
      }
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_385,this.var_222,_loc2_,-1,null);
         this._container.events.dispatchEvent(_loc3_);
      }
      
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_385,this.var_222,param2,-1,null);
         this._container.events.dispatchEvent(_loc3_);
      }
      ...
      private function getPetImage() : BitmapData
      {
         ...
         if(this.var_1206 < 8)
         {
            ...
            _loc2_ = this._container.avatarRenderManager.createPetImage(this.var_1206,this.var_1719,_loc1_,AvatarScaleType.const_56,this);
            if(_loc2_ != null)
            {
         ...
         {
            _loc3_ = 0;
            _loc4_ = this._container.roomEngine.getPetImage(this.var_1206,this.var_1719,new Vector3d(90),64,this,_loc3_);
            if(_loc4_ != null)
            {
               return _loc4_.data;
            }
