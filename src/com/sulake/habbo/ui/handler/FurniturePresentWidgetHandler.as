package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_824,RoomWidgetPresentOpenMessage.const_178];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_824:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_281);
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_66:
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_232)
                           {
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1509)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_351:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_596,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
