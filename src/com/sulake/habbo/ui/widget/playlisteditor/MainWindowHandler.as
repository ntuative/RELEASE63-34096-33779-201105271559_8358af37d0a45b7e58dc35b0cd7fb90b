package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private var var_1015:IBorderWindow;
      
      private var var_1016:IBorderWindow;
      
      private var var_543:MusicInventoryGridView;
      
      private var var_817:PlayListEditorItemListView;
      
      private var var_234:MusicInventoryStatusView;
      
      private var var_316:PlayListStatusView;
      
      private var var_1971:IScrollbarWindow;
      
      private var var_1972:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_235 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_738,PlayListEditorWidgetAssetsEnum.const_895,PlayListEditorWidgetAssetsEnum.const_486,PlayListEditorWidgetAssetsEnum.const_508,PlayListEditorWidgetAssetsEnum.const_951];
         ...
         this.var_817 = new PlayListEditorItemListView(param1,this.getPlayListEditorItemList());
         this.var_234 = new MusicInventoryStatusView(param1,this.getMusicInventoryStatusContainer());
      ...
      public function destroy() : void
      {
         if(this.var_235)
         {
            this.var_235.stop(HabboMusicPrioritiesEnum.const_396);
            this.var_235 = null;
         }
         if(this.var_543)
         {
      ...
      {
         this.var_235.requestUserSongDisks();
         var _loc1_:IPlayListController = this.var_235.getRoomItemPlaylist();
         if(_loc1_ != null)
         {
      ...
      public function refreshLoadableAsset(param1:String = "") : void
      {
         ...
         {
            this.assignWindowBitmapByAsset(this.var_1015,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_738);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_895)
         {
            this.assignWindowBitmapByAsset(this.var_1016,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_895);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_486)
         {
            this.var_234.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_486));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_508)
         {
            this.var_234.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_508));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_951)
         {
            this.var_316.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_951);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1015 = _loc2_.getChildByName("my_music_border") as IBorderWindow;
         ...
         this.var_1971 = this.var_1015.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_1972 = this.var_1016.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      {
         return this.var_1015.getChildByName("music_inventory_itemgrid") as IItemGridWindow;
      }
      ...
      {
         return this.var_1015.getChildByName("preview_play_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         {
            this.var_316.selectView(PlayListStatusView.const_794);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_234.show();
            this.var_234.selectView(MusicInventoryStatusView.const_688);
         }
         else if(this.var_235.getSongDiskInventorySize() <= const_1535)
         {
            this.var_234.show();
            this.var_234.selectView(MusicInventoryStatusView.const_891);
         }
         else
         {
            this.var_234.hide();
      ...
      private function updatePlaylistEditorView() : void
      {
         ...
         this.var_817.refresh(_loc2_,_loc3_);
      }
      ...
      public function onSongDiskInventoryReceived() : void
      {
         ...
         this.var_1971.visible = this.var_543.itemCount > const_1534;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_103:
               this.selectPlayListStatusViewByFurniPlayListState();
               this.var_817.setItemIndexPlaying(param1.position);
               if(param1.id != -1)
               {
                  _loc3_ = this.var_235.getSongInfo(param1.id);
            ...
            case RoomWidgetPlayListEditorNowPlayingEvent.const_133:
               ...
               this.var_234.songName = _loc2_ != null ? _loc2_.name : "";
               this.var_234.songName = _loc2_ != null ? _loc2_.name : "";
               this.var_234.authorName = _loc2_ != null ? _loc2_.creator : "";
               this.selectMusicStatusViewByMusicState();
               break;
      ...
      {
         return this.var_235.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_396) != -1;
      }
   }
}
