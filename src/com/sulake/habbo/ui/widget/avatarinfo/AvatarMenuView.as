package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1355:uint = 0;
      
      protected static const const_363:uint = 1;
      
      protected static const const_996:uint = 2;
      
      protected static var var_1382:uint = const_363;
      
      private static const const_1410:uint = 16744755;
      
      private static const const_1411:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1361)
         {
            ...
            {
               this.var_336 = const_996;
            }
            else
            {
               this.var_336 = var_1382;
            }
         }
         if(this.var_336 == const_1355)
         {
         ...
         if(this.var_336 == const_1355 || this.var_336 == const_363)
         {
            ...
            else
            {
               ...
               this.var_336 = const_363;
            }
         }
         if(this.var_336 == const_363)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = const_1359;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1362;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1411;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1410;
               }
            }
         }
         if(_loc3_)
