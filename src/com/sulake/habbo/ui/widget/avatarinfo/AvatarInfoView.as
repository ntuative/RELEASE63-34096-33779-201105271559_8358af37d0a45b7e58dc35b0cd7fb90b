package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1360:uint = 4281149991;
      
      protected static const const_1359:uint = 4283715916;
      
      protected static const const_1361:uint = 16777215;
      
      protected static const const_1362:uint = 9552639;
      ...
      protected var var_2193:FixedSizeStack;
      
      protected var var_2191:int = -1000000;
      
      protected var _disposed:Boolean;
      
      protected var var_488:Timer;
      
      protected var var_2970:int = 3000;
      
      protected var var_1648:Boolean;
      
      protected var var_1646:Boolean;
      
      protected var _blend:Number;
      
      protected var var_1645:int;
      
      protected var var_2969:int = 500;
      
      protected var var_1109:Boolean;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2193 = new FixedSizeStack(const_1598);
         super();
         this._widget = param1;
         this.var_1109 = true;
         this.var_1648 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1647 = param5;
         param1.var_2206 = param4;
         param1.var_2192 = param6;
         param1.var_1648 = false;
         param1.var_2969 = 500;
         param1.var_1646 = false;
         param1._blend = 1;
         if(param1.var_1109)
         {
            if(!param1.var_488)
            {
               param1.var_488 = new Timer(param1.var_2970,1);
               param1.var_488.addEventListener(TimerEvent.TIMER_COMPLETE,param1.onTimerComplete);
            }
            param1.var_488.reset();
            param1.var_488.start();
         }
         param1.updateWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_488)
         {
            this.var_488.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
            this.var_488.reset();
            this.var_488 = null;
         }
         this._disposed = true;
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_546));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1646)
         {
            ...
            this._blend = 1 - this.var_1645 / Number(this.var_2969);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1380)
         {
            ...
            if(this.var_1647 == RoomObjectTypeEnum.const_130 || this.var_1647 == RoomObjectTypeEnum.const_552)
            {
            ...
            this.var_2193.addValue(_loc5_);
            _loc6_ = this.var_2193.getMax();
            if(_loc6_ < this.var_2191 - const_1109)
            {
               _loc6_ = this.var_2191 - const_1109;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2191 = _loc6_;
