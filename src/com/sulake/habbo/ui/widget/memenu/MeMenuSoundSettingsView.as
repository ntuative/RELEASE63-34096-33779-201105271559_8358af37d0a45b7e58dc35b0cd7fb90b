package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_928 != null)
         {
            this.var_928.setValue(this.var_926);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_924 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_925 = (_loc5_.content as BitmapData).clone();
         }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_926 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_929);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_924);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_927);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_925);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_839);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_958);
         }
