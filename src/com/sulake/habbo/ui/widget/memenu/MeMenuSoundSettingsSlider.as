package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1653:MeMenuSoundSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1653.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_718 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_718.width,this.var_718.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_718,this.var_718.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1652 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
