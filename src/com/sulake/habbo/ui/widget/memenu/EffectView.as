package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2229:int = 1000;
      ...
      {
         super();
         this.var_209 = new Timer(this.const_2229);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_179.isActive)
         {
            ...
            this.var_915.width = _loc2_ * this.var_322;
         }
         else
         {
            this.var_915.width = 0;
            this.var_209.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_735 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_735 == null)
            {
               return;
            }
         ...
         if(!this.var_179.isActive)
         {
            this.var_735.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_735.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_914 = this._window.findChildByName("effect_hilite");
            this.var_914.visible = false;
         }
         this.setTimeLeft();
         this.var_915 = this._window.findChildByName("loader_bar");
         if(this.var_915 != null)
         {
            this.var_322 = this.var_915.width;
            this.var_209.start();
            this.onUpdate();
         }
