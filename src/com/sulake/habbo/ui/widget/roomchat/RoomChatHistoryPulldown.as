package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_233:int = 0;
      
      public static const const_88:int = 39;
      
      private static const const_1076:int = 150;
      
      private static const const_1077:int = 250;
      ...
      private var var_2699:BitmapData;
      ...
      private var var_2700:BitmapData;
      
      private var var_2702:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2699 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1964 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2703 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1963 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1965 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2701 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2700 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_80 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_330,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_88),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_80);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_40.height - const_88,param3.width,const_88),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_483,HabboWindowStyle.const_48,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_88),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_610:
               this.var_80.blend += param1 / const_1077;
               this._window.blend += param1 / const_1077;
               ...
               break;
            case const_1042:
               this.var_80.blend -= param1 / const_1076;
               this._window.blend -= param1 / const_1076;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_413:
               if(this._state == const_233)
               {
                  this.state = const_610;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_40.height - const_88;
            this._window.width = this.var_40.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_40.height - const_88;
            this._region.width = this.var_40.width - this.var_2702;
         }
         if(this.var_80 != null)
         {
            this.var_80.rectangle = this.var_40.rectangle;
            this.var_80.height -= const_88;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2698 == this._window.width)
         {
            return;
         }
         this.var_2698 = this._window.width;
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2699,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1964,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1964,destGripRBitmap);
         ...
         this.var_80.bitmap = this.var_2700;
