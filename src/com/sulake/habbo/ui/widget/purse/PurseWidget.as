package com.sulake.habbo.ui.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_2240:uint = 4.291993382E9;
      
      private const const_2239:uint = 4.29080704E9;
      
      private const const_2242:uint = 4.285767869E9;
      
      private const const_2241:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         if(_loc5_)
         {
            ...
            this._view.x = _loc6_.width - this._view.width - this.const_1984;
            this._view.y = this.const_1984;
      ...
      {
         this.var_1920 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1920.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1920.toString();
         }
      }
      ...
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1921.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1921.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1348));
      }
