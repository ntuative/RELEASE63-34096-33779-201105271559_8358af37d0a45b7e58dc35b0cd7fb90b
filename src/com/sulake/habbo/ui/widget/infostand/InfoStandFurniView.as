package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_245 = this.var_46.findChildByTag("catalog");
         if(this.var_245 != null)
         {
            this.var_245.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1240 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_628 && param1.isRoomOwner)
         {
         ...
         this.showButton("ParkBusDoorMessageEvent",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1328.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_51.addListItem(this.var_245);
            }
            this.var_245.visible = param1;
         }
         else
         {
            this.var_51.removeListItem(this.var_245);
         }
      }
   }
}
