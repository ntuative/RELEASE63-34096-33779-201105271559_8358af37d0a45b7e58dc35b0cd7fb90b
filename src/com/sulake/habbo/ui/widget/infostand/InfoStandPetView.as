package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1573:int = 152;
      
      private static const const_1570:int = 16;
      
      private static const const_677:int = 4;
      
      private static const const_1572:uint = 14342874;
      
      private static const const_1577:uint = 3815994;
      
      private static const const_1564:uint = 2085362;
      
      private static const const_1568:uint = 39616;
      
      private static const const_1566:uint = 10513106;
      
      private static const const_1575:uint = 8734654;
      
      private static const const_1565:uint = 9094430;
      
      private static const const_1567:uint = 6200576;
      
      private static const const_1574:String = "happiness";
      
      private static const const_1571:String = "experience";
      
      private static const const_1576:String = "energy";
      
      private static const const_1569:int = 250;
      
      private static const const_1100:int = 25;
      ...
      {
         if(this.var_51 == null || this.var_46 == null || this.var_101 == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1574,param1.nutrition,param1.nutritionMax,const_1568,const_1564);
         this.updateStateElement(const_1571,param1.experience,param1.experienceMax,const_1575,const_1566);
         this.updateStateElement(const_1576,param1.energy,param1.energyMax,const_1567,const_1565);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1573,const_1570,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1572);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1577);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_677,_loc7_.width - 2,_loc7_.height - 2 - const_677);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_677);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_529) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_210 && this.var_210.getPetId() == this.var_529)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1829,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_444,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1100 + const_1101;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1101;
            }
         }
         this.var_101.height = _loc4_ + const_1100;
         this.updateWindow();
      }
   }
}
