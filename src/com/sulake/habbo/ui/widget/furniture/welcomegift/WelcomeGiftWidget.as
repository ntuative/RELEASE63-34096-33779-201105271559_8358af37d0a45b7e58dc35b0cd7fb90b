package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_675:String = "welcome_gift_email_unverified";
      
      private const const_1086:String = "welcome_gift_email_verified";
      
      private const const_1550:String = "welcome_gift_email_change";
      
      private const const_2256:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1284)
         {
            this.setViewState(this.const_1086);
         }
         else
         {
            this.setViewState(this.const_675);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_675:
               ...
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1030);
               break;
            case this.const_1086:
      ...
      {
         this.setViewState(this.const_1550);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_906,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1284 ? this.const_1086 : this.const_675);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1564 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1564));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_529,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_990,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_529,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_990,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_529:
               this.var_1565 = param1.email;
               this.var_1284 = param1.isVerified;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1565 = this.var_1564;
            this.setViewState(this.const_675);
         }
         else
         {
            if(param1.result == this.const_2256)
            {
               this.var_1030 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1564);
