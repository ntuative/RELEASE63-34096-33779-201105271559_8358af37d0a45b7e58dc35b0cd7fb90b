package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_2092) as IWindowContainer;
            ...
            _loc3_.width = this.var_696.width;
            _loc3_.height = this.var_696.height;
            this.var_568.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_696.width,this.var_696.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_696,this.var_696.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1338.width,this.var_1338.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1079.width,this.var_1079.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1079,this.var_1079.rect,new Point(0,0),null,null,true);
