package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1995:int = 1;
      
      private const const_1990:int = 2;
      
      private const const_1994:int = 3;
      
      private const const_1991:int = 4;
      
      private const const_2254:int = 0;
      
      private const const_2251:int = 1;
      
      private const const_2253:int = 2;
      
      private const const_2249:int = 3;
      
      private const const_2255:int = 4;
      
      private const const_2252:int = 5;
      
      private const const_1992:String = "deco_img";
      
      private const const_1993:String = "dialog_bg";
      
      private const const_2248:String = "%campaign%_dialog_bg.png";
      
      private const const_369:String = "%campaign%_gift_package.png";
      
      private const const_2250:String = "%campaign%_gift_content.png";
      
      private const const_2247:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1557 = this.var_144.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1557 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1558.length)
         {
            _loc2_ = this.var_1558.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_144 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_533,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_835,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_533,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_533:
               _loc2_ = this.const_1989;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_725:
               ...
               if(_loc5_)
               {
                  ...
                  {
                     _loc2_ = this.const_1990;
                  }
               }
               else
               {
                  _loc2_ = this.const_1991;
               }
               this._shareId = null;
               this.var_1556 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_835:
               _loc2_ = this.const_1995;
               this.var_222 = param1.objectId;
               this._shareId = param1.data;
               this.var_410 = param1.status;
               this.var_1556 = param1.itemCategory;
         ...
         if(this._window && (this.var_1555 != _loc2_ || _loc3_ != this.var_190))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_190 = _loc3_;
         this.var_1555 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1555)
            {
               ...
               case this.const_1995:
                  if(this.var_410 == this.const_2254)
                  {
                  ...
                  else if(this.var_410 == this.const_2251)
                  {
                  ...
                  else if(this.var_410 == this.const_2253)
                  {
                  ...
                  else if(this.var_410 == this.const_2249)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_410 == this.const_2255)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_190,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_410 == this.const_2252)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2248.replace("%campaign%",this.var_190);
            this.setDecoImage(_loc5_,this.const_1993);
            _loc2_ = _loc2_.replace("%campaign%",this.var_190);
            this.setDecoImage(_loc2_,this.const_1992);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_800);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1556 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1556 == 1 ? "null" : InventoryCategory.const_128);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_696,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1558.push(new ImageDownloader(this,_assets,this.var_190,this.var_1557,param1,param2));
            return;
         }
