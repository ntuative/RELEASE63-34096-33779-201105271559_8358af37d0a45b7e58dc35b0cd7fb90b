package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1580:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1311 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2815 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2814 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_392 = new Timer(1000,1);
         this.var_392.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_462 = new Timer(10000,1);
         this.var_462.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_462.reset();
            this.var_462.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_462 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1587 = this._window.findChildByName("block_text");
         this.var_2034.caption = const_1580;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_208,this.windowKeyEventProcessor);
         this.var_26.addEventListener(WindowKeyboardEvent.const_353,this.keyUpHandler);
         ...
         this.var_1588 = true;
         this.var_676 = "";
         this._window.addEventListener(WindowEvent.const_881,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_464,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1578 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1579);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1311 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_676 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_675);
