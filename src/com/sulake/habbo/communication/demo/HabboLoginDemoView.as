package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_574:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_164.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_161,HabboWindowStyle.const_48,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1985,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_164.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1985,"/");
         ...
         {
            dispatchEvent(new Event(const_574));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_146.removeEventListener(SSOTicket.const_394,this.onParsedTicketSuccess);
            this.var_146.removeEventListener(SSOTicket.const_333,this.onParsedTicketFailure);
            this.var_146 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_146 = new SSOTicket(this.var_164.assets,_loc3_,_loc2_,param1);
         this.var_146.addEventListener(SSOTicket.const_394,this.onParsedTicketSuccess);
         this.var_146.addEventListener(SSOTicket.const_333,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_146.ticket);
         Logger.log("Has Facebook: " + this.var_146.isFacebookUser);
         if(this.var_146.isFacebookUser)
         {
            this.var_164.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_164.flashClientUrl = this.var_146.flashClientUrl;
         this.var_164.ssoTicket = this.var_146.ticket;
         this.var_146.removeEventListener(SSOTicket.const_394,this.onParsedTicketSuccess);
         this.var_146.removeEventListener(SSOTicket.const_333,this.onParsedTicketFailure);
         this.var_146 = null;
         dispatchEvent(new Event(const_574));
