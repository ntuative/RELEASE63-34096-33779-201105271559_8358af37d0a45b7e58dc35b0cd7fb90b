package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1059:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1119:Function;
      
      private var var_1117:Function;
      
      private var var_725:IAssetLibrary;
      
      private var var_1118:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_725 = param2;
         this._events = param3;
         this.var_1059 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_725.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_725.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_725.loadAssetFromFile("hotel_view_banner_" + this.var_1118,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_851));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1059.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1059.removeChild(this._window);
         }
      }
   }
}
