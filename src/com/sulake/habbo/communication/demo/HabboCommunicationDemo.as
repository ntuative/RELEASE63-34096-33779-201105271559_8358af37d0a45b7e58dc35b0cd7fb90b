package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2658:PseudoRandom;
      ...
      private const const_1985:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_652 = param1;
            this.var_56.initConnection(HabboConnectionType.const_239);
         }
      }
      ...
      {
         if(this.var_56 && this.var_144 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_652 = this.var_144.getKey("sso.ticket",null);
         this.var_1938 = this.var_144.getKey("flash.client.url","");
         this.var_2660 = this.var_144.getKey("external.variables.txt","");
         if(this.var_232 == null)
         {
            this.var_232 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_574,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1657);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1160;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_239);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2658 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_90:
               ...
               this.var_1533 = _loc4_;
               this.var_232.loadBannerImage(_loc7_ + "?token=" + this.var_1533,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1160:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1666:
               this.var_1003 = this.generateRandomHexString(30);
               this.var_537 = new DiffieHellman(new BigInteger(this.var_144.getKey("connection.development.prime"),16),new BigInteger(this.var_144.getKey("connection.development.generator"),16));
               this.var_537.init(this.var_1003);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2658);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1938,this.var_2660));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1985,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_652 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_652);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2659)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1533);
