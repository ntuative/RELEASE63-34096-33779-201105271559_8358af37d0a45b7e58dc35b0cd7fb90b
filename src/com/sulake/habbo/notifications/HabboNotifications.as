package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1539:String = "pixelbalance";
      
      private static const const_1543:String = "badges";
      
      private static const const_1540:String = "selectbadge";
      
      private static const const_1544:String = "inventory";
      
      private static const const_1546:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1541:String = "friendlist";
      
      private static const const_1545:String = "pet_inventory";
      
      private static const const_1542:String = "go_to_room";
      ...
      private var var_381:HabboNotificationViewManager;
      ...
      private var var_1024:ClubGiftNotification;
      
      private var var_1026:ClubEndingNotification;
      
      private var var_1023:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1025);
         }
         var _loc6_:Map = this.var_1025["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1025["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1281.push(_loc8_);
         return this.var_1281.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1281.splice(0,1);
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_381)
         {
            this.var_381.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1554[_loc3_.data.badgeCode] = new AchievementNotification(_loc3_.data.badgeCode,_loc3_.data.achievementID,_loc3_.data.level,_loc3_.data.points,_loc3_.data.levelRewardPoints,_loc3_.data.levelRewardPointType,_loc3_.data.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_378);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1554[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1554[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_381 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1025["styles"],this.var_1025["view"]);
         ...
         registerUpdateReceiver(this.var_381,1);
         registerUpdateReceiver(this,2);
         this.var_378.events.addEventListener(BadgeImageReadyEvent.const_113,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_378.userId == _loc2_.userId)
         {
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1795,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_534.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               if(_loc6_.productType == CatalogPageMessageProductData.const_81)
               {
                  _loc7_ = this.var_378.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_66)
               {
                  _loc7_ = this.var_378.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_378.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1663,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1245)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1813,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1901)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1026 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1023 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_381.isSpaceAvailable() && this.var_1281.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_381.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1545:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_128);
               }
               break;
            case const_1546:
               break;
      ...
      {
         if(param1 != null && this.var_381 != null)
         {
            this.var_381.replaceIcon(param1);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1189,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1189,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_534.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_56);
            if(_loc6_ != null)
            {
      ...
      {
         if(param2.type == WindowEvent.const_175 || param2.type == WindowEvent.const_515)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1024 && this.var_1024.visible)
         {
            return;
         }
         this.var_1024 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
