package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2044:int = "F".charCodeAt(0);
      
      public static const const_2167:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_800 = param1.online;
         this.var_1947 = param1.followingAllowed && param1.online;
         this.var_666 = param1.figure;
         this.var_1946 = param1.motto;
         this.var_1924 = param1.lastAccess;
         this.var_1526 = param1.categoryId;
         this.var_1922 = param1.realName;
