package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2882:FriendListLookAndFeel;
      
      private var var_418:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2080:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_692.stop();
            this.var_692.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_692 = null;
         }
         ...
         if(this.var_1077)
         {
            this.var_1077.release(new IIDAvatarRenderManager());
            this.var_1077 = null;
         }
         if(this.var_1044)
         {
            this.var_1044.release(new IIDHabboNotifications());
            this.var_1044 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_867)
         {
            this.var_867.release(new IIDSessionDataManager());
            this.var_867 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2080 = new OpenedToWebPopup(this);
         }
         this.var_2080.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_386);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_330,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1077.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_1044 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_1135,this.getText("friendlist.friends")));
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_427,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_107.addFriend(new Friend(_loc4_));
         }
         this.var_418 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_692)
         {
            this.var_692 = new Timer(120000);
            this.var_692.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_692.start();
         }
         ...
         {
            _loc5_ = this.var_107.findCategory(FriendCategory.const_427);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_418.findTab(FriendListTab.const_102).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_418.findTab(FriendListTab.const_102);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2079.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_418.findTab(FriendListTab.const_102);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_867 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_867.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_867.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_180) as IBitmapWrapperWindow;
