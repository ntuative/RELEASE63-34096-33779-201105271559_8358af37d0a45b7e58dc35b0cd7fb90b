package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1554:int = 20;
       
      
      private var var_143:HabboMessenger;
      
      private var var_2756:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_143 = param1;
         this.var_1995 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_60 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2756 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1093 + const_1554)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1995.enable();
         }
         else
         {
            this.var_1995.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_60.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_551.messages.length - const_1093);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_886 || param3.type == Message.const_695 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_143.send(new FollowFriendMessageComposer(this.var_551.id));
         this.var_143.send(new ConversionPointMessageComposer("Navigation","IM","go.im"));
      }
