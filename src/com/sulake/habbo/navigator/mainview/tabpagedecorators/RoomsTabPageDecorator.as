package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_138:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_138 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_138.addEventListener(WindowEvent.const_50,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_138 != null)
         {
            this.var_138.removeEventListener(WindowEvent.const_50,this.onFilterSelected);
            this.var_138.selection = 0;
            this.var_138.addEventListener(WindowEvent.const_50,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_138 == null ? 0 : int(this.var_138.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_431);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_745);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_431,"" + _loc3_);
         }
         if(this.var_138)
         {
            this._navigator.trackNavigationDataPoint(this.var_138.enumerateSelection()[this.var_138.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_138 ? this.var_138.enumerateSelection()[this.var_138.selection] : null;
      }
   }
}
