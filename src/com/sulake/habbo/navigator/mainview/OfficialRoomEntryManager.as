package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1384:int = 267;
      
      private static const const_1385:int = 65;
      
      private static const const_1386:int = -70;
      ...
      private var var_2351:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2351 = new PublicRoomThumbs();
         super();
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1722)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_836 || param2.type == OfficialRoomEntryData.const_780))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1385) : int(const_1384);
      ...
      {
         var _loc4_:String = this.var_2351.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1386) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_217,Tabs.const_418,_loc2_.tag);
         }
         else if(_loc2_.publicRoomData != null)
         {
            Logger.log("ENTERING PUBLIC SPACE: " + _loc2_.publicRoomData.method_1);
            this._navigator.send(new GetPublicSpaceCastLibsMessageComposer(_loc2_.publicRoomData.method_1));
