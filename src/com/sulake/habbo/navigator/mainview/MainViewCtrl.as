package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1394:int = 4;
      ...
      private var var_933:PopularTagsListCtrl;
      
      private var var_934:GuestRoomListCtrl;
      ...
      private var var_1425:IWindow;
      
      private var var_746:IRegionWindow;
      ...
      private var var_745:WindowToggle;
      
      private const const_1963:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_933 = new PopularTagsListCtrl(this._navigator);
         this.var_934 = new GuestRoomListCtrl(this._navigator);
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         if(!this.var_745 || this.var_745.disposed)
         {
            this.var_745 = new WindowToggle(this.var_17,this.var_17.desktop,this.reloadData,this.close);
         }
         var _loc1_:int = this.var_745.toggle();
      ...
      private function prepare() : void
      {
         ...
         this.var_282 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         ...
         this.var_1425 = this.var_17.findChildByName("loading_text");
         ...
         this.var_746 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(this.var_746 != null)
         {
            this.var_746.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onHotelViewMouseOver);
            this.var_746.addEventListener(WindowMouseEvent.const_25,this.onHotelViewMouseOut);
            this.var_746.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onHotelViewMouseClick);
         }
         this.refreshToHotelViewButton(false);
         this.var_17.addEventListener(WindowEvent.const_40,this.onWindowResized);
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_282.getTabItemByID(_loc2_.id);
            if(_loc3_ != null)
            {
               _loc3_.addEventListener(WindowEvent.const_50,this.method_10);
               _loc2_.button = _loc3_;
            }
         }
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_932,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1806,true);
         this.var_17.position = this.const_1963;
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_183,["custom_content","list_content"],this.var_225.y,8);
         this.var_202.height = this.var_202.height + _loc1_ - this.var_202.y - this.var_250.height + this.var_2375;
         Util.moveChildrenToColumn(this.var_183,["list_content","custom_footer"],this.var_202.y,0);
         this.var_2375 = this.var_250.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_282.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1722 = true;
            this.var_282.selector.setSelected(_loc1_.button);
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_934,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_933,"popular_tags");
      }
      ...
      private function getSearchMsg(param1:int, param2:String) : IMessageComposer
      {
         ...
         if(param1 == Tabs.const_827)
         {
            return new MyFriendsRoomsSearchMessageComposer();
         }
         if(param1 == Tabs.const_939)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_599 == const_1023)
         {
            ...
            this.var_250.blend = !!this.var_1162 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_599 = const_653;
            }
         }
         else if(this.var_599 == const_653)
         {
            if(this.var_1426 % 10 == 1)
            {
               this.var_1425.visible = !this.var_1425.visible;
            }
            ++this.var_1426;
            if(!this._navigator.data.isLoading())
            {
               this.var_599 = const_1022;
            }
         }
         else if(this.var_599 == const_1022)
         {
            this.refresh();
            this.var_599 = const_1394;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_933);
         this.refreshScrollbar(this.var_934);
      }
      ...
      {
         this._navigator.refreshButton(this.var_746,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_746,"icon_hotelview_reactive",param1,null,0);
      }
