package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_513:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_513 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_577 = IScrollbarWindow(this.var_183.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_222,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1803,true);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_513.visible && this.var_2442)
         {
            return;
         }
         ...
         this.var_513.room = _loc4_;
         this.var_513.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1447.tags[0];
            this.var_1447.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2443 - _loc2_.stageX);
         this.var_2443 = _loc2_.stageX;
         this.var_2442 = _loc3_ > 2;
      }
   }
}
