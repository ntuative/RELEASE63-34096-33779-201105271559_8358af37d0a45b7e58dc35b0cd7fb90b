package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1194)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1933)
         {
      ...
      private function onPublicSpaceCastLibs(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Got public space cast libs: " + _loc2_.method_1 + ", " + _loc2_.unitPort + ", " + _loc2_.castLibs);
         this._navigator.data.publicSpaceNodeId = _loc2_.method_1;
