package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1169:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_301 = new MainViewCtrl(this);
         this.var_612 = new RoomInfoViewCtrl(this);
         this.var_1169 = new RoomCreateViewCtrl(this);
         ...
         this.var_418 = new Tabs(this);
         this.var_1170 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_330,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_301.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_301.startSearch(Tabs.const_217,Tabs.const_418,param1);
         this.var_301.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_301.startSearch(Tabs.const_296,Tabs.const_248);
         this.var_418.getTab(Tabs.const_296).tabPageDecorator.tabSelected();
      }
