package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_448 = new Timer(500,1);
         this.var_376 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1098 = param4;
         this.var_2665 = param2;
         this._popupIndentLeft = param3;
         this.var_448.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_448)
         {
            this.var_448.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_448.reset();
            this.var_448 = null;
         }
         if(this.var_376)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_57 == null)
         {
            this.var_57 = IWindowContainer(this._navigator.getXmlWindow(this.var_1098));
            this.var_57.visible = false;
            this.var_57.setParamFlag(HabboWindowParam.const_44,true);
         ...
         this.var_57.x = _loc2_.x + this.var_2665 + param1.width;
