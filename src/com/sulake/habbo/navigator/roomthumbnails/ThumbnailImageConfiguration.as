package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1937:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1935 = this._navigator.getButtonImage(this.var_1934);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1937 == null)
         {
            ...
            this.var_1937 = new Rectangle(this.var_1529,this.var_1529,_loc1_.width - 2 * this.var_1529,_loc1_.height - 2 * this.var_1529);
         }
         this.var_651.bitmap.fillRect(this.var_651.bitmap.rect,4281545523);
         this.var_651.bitmap.fillRect(this.var_1937,4284900966);
         this.copyTo(this.var_651.bitmap);
         if(this._selected)
         {
            this.var_651.bitmap.copyPixels(this.var_1936,this.var_1936.rect,new Point(0,0),null,null,true);
         }
