package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1553:CutToWidth = new CutToWidth();
      
      private static var var_2723:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1553.beforeSearch(param2,param1,param3);
         method_8(var_1553,param2.length - 1);
      }
      
      public static function method_8(param1:BinarySearchTest, param2:int) : void
      {
         var _loc5_:int = 0;
