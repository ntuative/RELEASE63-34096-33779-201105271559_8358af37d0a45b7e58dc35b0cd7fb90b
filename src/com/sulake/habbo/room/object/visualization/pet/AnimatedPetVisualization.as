package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1503:String = "head";
      
      private static const const_671:int = 1;
      
      private static const const_1065:int = 1000;
      
      private static const const_1502:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1502) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_370 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2628)
            {
               this.var_2628 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_153)
         {
            ...
            if(!isNaN(_loc6_))
            {
               _loc10_ = this._animationData.getPostureCount(var_95);
               if(_loc10_ > 0)
               {
                  _loc4_ = this._animationData.getPostureForAnimation(var_95,_loc6_ % _loc10_);
                  _loc5_ = null;
               }
            }
            ...
            if(!isNaN(_loc7_))
            {
               _loc11_ = this._animationData.getGestureCount(var_95);
               if(_loc11_ > 0)
               {
                  _loc5_ = this._animationData.getGestureForAnimation(var_95,_loc7_ % _loc11_);
               }
            }
            this.validateActions(_loc4_,_loc5_);
            this.var_1812 = _loc3_.getNumber(RoomObjectVariableEnum.const_416) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_216);
            if(!isNaN(_loc8_))
            {
               this.var_1896 = _loc8_;
            }
            else
            {
               this.var_1896 = direction;
            }
            this.var_1509 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2629 = _loc3_.getNumber(RoomObjectVariableEnum.const_940);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_716);
            if(_loc9_ != this.var_1897)
            {
               this.var_1897 = _loc9_;
               this.var_2627 = this.var_1897.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_370 != null)
         {
            ...
            if(this.var_1509 > 0)
            {
               _loc2_ = param1 - this.var_1509;
               if(_loc2_ < const_1065)
               {
                  this.var_370.alpha = int(Math.sin(_loc2_ / const_1065 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_370.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_370.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_258)
         {
            this.var_258 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_95,param1);
            this.setAnimationForIndex(const_1504,_loc3_);
         }
         if(param2 != this.var_1479)
         {
            this.var_1479 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_95,param2);
            this.setAnimationForIndex(const_1505,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_671;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2627);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_671)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_671))
            {
               if(param2 >= FurnitureVisualizationData.const_528.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_528[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1896);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_95,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1503)
            {
               this.var_991[param1] = true;
            }
            else
            {
               this.var_991[param1] = false;
            }
         }
