package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_627:PetVisualizationData = null;
      ...
      private const const_1452:int = 3;
      ...
      private var var_1813:Number = NaN;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_560.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_560.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_627 = param1 as PetVisualizationData;
         createSprites(this.const_1452);
         var _loc2_:BitmapData = (this.var_627.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_370 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1812 = param1.getNumber(RoomObjectVariableEnum.const_416) > 0;
            this.var_1479 = param1.getString(RoomObjectVariableEnum.const_156);
            this.var_258 = param1.getString(RoomObjectVariableEnum.const_240);
            this.var_1478 = param1.getString(RoomObjectVariableEnum.const_884);
            this.var_1813 = param1.getNumber(RoomObjectVariableEnum.const_216);
            this.var_1509 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2629 = param1.getNumber(RoomObjectVariableEnum.const_940);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_484 != param1.getUpdateID() || this.var_1703 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1813;
            if(isNaN(this.var_1813))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc5_ != this.var_1814 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_560.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_627.getAvatar(this.var_666,param1,this);
            if(_loc3_ != null)
            {
               this.var_560.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_629 = null;
         _loc2_ = getSprite(this.const_1998);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_95 || this.var_59 == null)
         {
            if(_loc7_ != var_95)
            {
               var_95 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_931 || this.var_1315 > 0 || this.var_2041;
         this.var_370.alpha = 0;
         if(this.var_1509 > 0)
         {
            _loc13_ = param2 - this.var_1509;
            if(_loc13_ < AvatarAction.const_1065)
            {
               this.var_370.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_370.setExperience(this.var_2629);
               this.var_1315 = this.const_2260;
            }
            else
            {
               this.var_1509 = 0;
            }
            _loc14_ = getSprite(this.const_1974);
            if(_loc14_ != null)
            {
               if(this.var_370.alpha > 0)
               {
                  _loc14_.asset = this.var_370.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_370.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1039);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1479 != null && this.var_1479 != "")
         {
            param1.appendAction(AvatarAction.const_322,this.var_1479);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1452;
