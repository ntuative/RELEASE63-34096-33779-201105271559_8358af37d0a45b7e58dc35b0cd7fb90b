package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1841:int = 16777215;
      
      public static const const_1822:int = 13421772;
      
      private static const const_1016:int = 16777215;
      
      private static const const_1015:int = 13421772;
      
      private static const const_1017:int = 10066329;
      
      private static const const_1014:int = 10066329;
      
      public static const const_1783:int = 16777215;
      
      public static const const_1779:int = 13421772;
      
      public static const const_1945:int = 10066329;
      ...
      private var var_736:Rectangle = null;
      ...
      private var var_1701:String = null;
      ...
      private var var_2070:int = -1000;
      
      private const const_2230:int = 250;
      ...
      private var var_1700:Number = 0.0;
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_135 != null)
         {
            ...
            {
               _loc2_ = this.var_135[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_736 = super.boundingRectangle;
         }
         return new Rectangle(this.var_736.x,this.var_736.y,this.var_736.width,this.var_736.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_135.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_135[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1276);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1340);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_259)
            {
               ...
               {
                  _loc13_.color = const_1016;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1015;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_420)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1734)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_71,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_420)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2070 + this.const_2230 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_348.length)
            {
               _loc11_ = this.var_596[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_348[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1702)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2325 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2326 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2322 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1703)
         {
            this.var_1703 = param1.updateId;
            this.var_736 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1606 || _loc3_.y != this.var_2324 || _loc3_.z != this.var_2323 || param1.scale != this.var_1700))
            {
               this.var_1606 = _loc3_.x;
               this.var_2324 = _loc3_.y;
               this.var_2323 = _loc3_.z;
               this.var_1700 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1211);
            if(_loc3_ != this.var_1701)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1701 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_812));
            if(_loc4_ != this.var_1133)
            {
               this.var_1133 = _loc4_;
               this.var_2325 = this.var_1133 & 255;
               this.var_2326 = this.var_1133 >> 8 & 255;
               this.var_2322 = this.var_1133 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_153 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_191);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_952));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_848));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_973));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_135[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_348;
         if(this.var_348.length == 0)
         {
            _loc6_ = this.var_135;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_348.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_348.push(_loc12_);
                        this.var_596.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1134;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_135.length)
         {
            _loc3_ = this.var_135[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc8_ < this.var_500.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               {
                  _loc3_ = this.var_135[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_71 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_277)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_135[_loc18_] as RoomPlane;
