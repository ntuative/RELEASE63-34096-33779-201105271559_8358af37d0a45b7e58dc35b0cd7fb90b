package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationFrame
   {
      ...
      private static const const_1433:int = 3000;
      ...
      public static function allocate(param1:int, param2:int, param3:int, param4:int, param5:int, param6:Boolean, param7:int = -1, param8:int = 0) : AnimationFrame
      {
         ...
         _loc9_.var_2491 = param6;
         if(param4 < 1)
         {
            param4 = 1;
         }
         _loc9_.var_2362 = param4;
         if(param5 < 0)
         {
            param5 = const_608;
         }
         _loc9_.var_946 = param5;
         _loc9_.var_1775 = param5;
         if(param7 >= 0)
         {
            _loc9_.var_2489 = param7;
            _loc9_.var_2490 = param8;
         }
         return _loc9_;
      }
