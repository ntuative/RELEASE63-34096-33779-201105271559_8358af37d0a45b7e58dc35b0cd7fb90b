package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1955:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2670:Number = NaN;
      ...
      private var var_2668:Number = 0.0;
      
      private var var_2671:int = -1;
      
      private var var_2669:int = -1;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1535 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1535;
            this.var_1535 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_680 != spriteCount)
         {
            createSprites(this.var_680);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2614;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_484 != _loc3_.getUpdateID() || param1 != var_95 || param2 != this.var_2670)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2667 = _loc3_.getNumber(RoomObjectVariableEnum.const_236);
            ...
            this.var_1258 = this.getAdClickUrl(_loc3_);
            if(this.var_1258 == null || this.var_1258.indexOf("http") != 0)
            {
               this.var_1258 = null;
            }
            this.var_2614 = this.var_1258 != null;
            this.var_2666 = _loc3_.getNumber(RoomObjectVariableEnum.const_965);
      ...
      {
         if(this.var_2669 != param2 || this.var_2668 != param1)
         {
            this.var_1006 = [];
            this.var_1007 = [];
            this.var_806 = [];
            ...
            this.var_2671 = this.getSize(param1);
      ...
      {
         this.var_680 = param1;
         this.var_1534 = this.var_680 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_528.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1006[param2];
         var _loc4_:Boolean = this.var_1007[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2671;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1534)
            {
               _loc6_ = FurnitureVisualizationData.const_528[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1006[param2] = _loc3_;
            this.var_1007[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_805[param3] != null && !this.var_1948)
         {
      ...
      {
         if(this.var_808[param2] != null)
         {
            return this.var_808[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2666 * (param1 / 2));
      }
