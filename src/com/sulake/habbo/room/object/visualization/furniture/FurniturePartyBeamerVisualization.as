package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1029:int = 15;
      
      private static const const_1030:int = 31;
      
      private static const const_1413:int = 2;
      
      private static const const_1412:int = 1;
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc4_:int = this.var_1174[param2];
         var _loc5_:int = this.var_1172[param2];
         var _loc6_:Number = this.var_1171[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1029;
         }
         ...
         if(int(_loc9_) == 0)
         {
            this.var_1171[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1174.push(1);
         this.var_1174.push(-1);
         this.var_1172 = new Array();
         this.var_1172.push(const_1413);
         this.var_1172.push(const_1412);
         this.var_1171 = new Array();
         this.var_1171.push(this.getRandomAmplitudeFactor());
         this.var_1171.push(this.getRandomAmplitudeFactor());
      }
