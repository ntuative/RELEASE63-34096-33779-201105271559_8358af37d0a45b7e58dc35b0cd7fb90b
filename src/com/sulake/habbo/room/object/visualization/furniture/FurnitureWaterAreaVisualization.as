package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1480:String = "shore";
      ...
      {
         if(this.var_2594 == param1 && this.var_2595 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1480)
            {
               this.var_1872 = _loc2_;
               this.var_2594 = param1;
               this.var_2595 = direction;
               return this.var_1872;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1233.indexOf(_loc2_) < 0)
            {
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_635[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_635[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_526 == 0 || this.var_634 == 0)
         {
            ...
            this.var_526 = _loc2_.getNumber(RoomObjectVariableEnum.const_309);
            this.var_634 = _loc2_.getNumber(RoomObjectVariableEnum.const_373);
         }
         this.var_438 = [];
         this.var_635 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_526 * 2 + this.var_634 * 2)
         {
            this.var_438.push(false);
            this.var_635.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      {
         if(this.var_75 == null || this.var_75.width < param1 || this.var_75.height < param2)
         {
            if(this.var_75 != null)
            {
               this.var_75.dispose();
            }
            this.var_75 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_75,getSize(param3),this.var_438,this.var_635,assetCollection);
      }
