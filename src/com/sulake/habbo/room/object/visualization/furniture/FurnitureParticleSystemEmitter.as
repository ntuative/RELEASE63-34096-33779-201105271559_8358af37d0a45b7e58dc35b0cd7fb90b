package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1647:String = "cone";
      
      public static const const_1888:String = "plane";
      
      public static const const_1886:String = "sphere";
      ...
      private var var_1066:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_1065 = 0;
         this.var_994 = false;
         this.init(0,0,0,this._direction,this.var_2843,this.var_1066,this.var_2847,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1326.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_994 = true;
         if(this.var_1065 < this.var_1598)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2848)
         {
            switch(this.var_2844)
            {
               case const_1647:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1066,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1326.length);
         return this.var_1326[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1065 < this.var_1598)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1065 < this.var_1598)
         {
            ...
            this.y = (2 - this.var_280) * this.y - (1 - this.var_280) * this.lastY + this.var_2049 * this.var_1066 * this.var_1066;
         ...
         for each(_loc2_ in this.var_395)
         {
            ...
            _loc2_.y = (2 - this.var_280) * _loc2_.y - (1 - this.var_280) * _loc2_.lastY + this.var_2049 * this.var_1066 * this.var_1066;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_395.splice(this.var_395.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
