package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1677:int = 255;
      
      private var var_1613:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_567,RoomObjectMouseEvent.const_159];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1276,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_812,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_952,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_848,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_973,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1336)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1677;
            if(_loc2_ - this.var_1336 >= this.var_2089)
            {
               _loc3_ = this.var_1337;
               _loc4_ = this.var_2090;
               this.var_1336 = 0;
            }
            else
            {
               _loc7_ = this.var_1613 >> 16 & 255;
               _loc8_ = this.var_1613 >> 8 & 255;
               _loc9_ = this.var_1613 & 255;
               _loc10_ = this.var_1337 >> 16 & 255;
               _loc11_ = this.var_1337 >> 8 & 255;
               _loc12_ = this.var_1337 & 255;
               _loc13_ = (_loc2_ - this.var_1336) / this.var_2089;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2091 + (this.var_2090 - this.var_2091) * _loc13_;
               this._color = _loc3_;
               this.var_1677 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_812,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_957:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_917:
               param2.setString(RoomObjectVariableEnum.const_205,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_772:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_526:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_277)
               {
                  _loc5_ = "null";
               }
               this.var_500.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_746:
               _loc4_ = this.var_500.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_500.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1211,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1137:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1220:
               param2.setNumber(RoomObjectVariableEnum.const_848,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_973,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_654:
               param2.setNumber(RoomObjectVariableEnum.const_1352,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1202:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1613 = this._color;
         this.var_2091 = this.var_1677;
         this.var_1337 = _loc3_;
         this.var_2090 = _loc4_;
         this.var_1336 = getTimer();
         this.var_2089 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1691,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1801,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1884,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_259 || _loc12_ == RoomPlaneData.const_420)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
