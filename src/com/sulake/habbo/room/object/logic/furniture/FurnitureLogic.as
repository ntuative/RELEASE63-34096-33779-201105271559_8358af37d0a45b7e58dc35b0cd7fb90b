package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private var var_1228:RoomObjectUpdateMessage;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_326,RoomObjectRoomAdEvent.const_319,RoomObjectRoomAdEvent.const_465,RoomObjectStateChangeEvent.const_64,RoomObjectMouseEvent.const_159,RoomObjectRoomAdEvent.const_200,RoomObjectMouseEvent.const_480];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         this.var_2589 = this.var_526 / 2;
         this.var_2588 = this.var_634 / 2;
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_309,this.var_526,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_373,this.var_634,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_846,this.var_1498,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1800,this.var_2589,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1731,this.var_2588,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1290,this.var_1868,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_776,this.var_256,true);
      ...
      protected function handleAdClick(param1:int, param2:String, param3:String) : void
      {
         ...
         {
            eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_200,param1,param2));
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               if(eventDispatcher != null)
               {
                  _loc4_ = object.getId();
                  _loc5_ = object.getType();
                  _loc6_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_480,param1.eventId,_loc4_,_loc5_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
                  eventDispatcher.dispatchEvent(_loc6_);
               }
         }
      }
      ...
      override public function useObject() : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_465,_loc1_,_loc2_));
               }
            }
            if(eventDispatcher != null)
            {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_727,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1261,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_1867 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_365 = 1;
                  this.var_1228 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_1867 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_365 > 0)
         {
            this.var_979.x = 0;
            this.var_979.y = 0;
            if(this.var_365 <= const_456 / 2)
            {
               this.var_979.z = const_1051 * this.var_365;
            }
            else if(this.var_365 <= const_456)
            {
               if(this.var_1228)
               {
                  super.processUpdateMessage(this.var_1228);
                  this.var_1228 = null;
               }
               this.var_979.z = const_1051 * (const_456 - this.var_365);
            }
            return this.var_979;
         }
         return null;
