   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2291 = param1.extra;
            this.var_1126 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1126 > 0 && param1 >= this.var_1126)
         {
            this.var_1126 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1680,String(this.var_1680),this.var_2291);
