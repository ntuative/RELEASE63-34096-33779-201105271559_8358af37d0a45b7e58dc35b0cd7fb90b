package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_654:Number = 0.25;
      
      private static const const_1202:Number = 0.25;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_609.push(_loc5_);
            _loc3_++;
         }
         this.var_248 = param1;
         this._height = param2;
         this.var_422 = this.var_248;
         this.var_423 = -1;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         {
            _loc4_ = this.var_118[param2] as Array;
            ...
            else
            {
               ...
               if(param2 == this.var_420 || param2 == this.var_421)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_422;
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_118[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc2_ < this._height)
         {
            ...
            {
               this.var_609[_loc2_][_loc8_] = this.var_118[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         var _loc3_:Point = findEntranceTile(this.var_118);
         var _loc4_:int = 0;
         if(_loc3_ != null)
         {
         ...
         this.var_1009 = getFloorHeight(this.var_118);
         if(!param1)
         {
         ...
         var _loc6_:* = [];
         var _loc7_:int = 0;
         while(_loc7_ < this.var_118.length)
         {
            _loc5_ = this.var_118[_loc7_];
            _loc9_ = [];
            _loc10_ = 0;
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_420,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1202 * this.var_1410;
         var _loc9_:Number = const_654 * this._floorThicknessMultiplier;
      ...
      {
         if(param1 == null || this.var_118 == null || param1 == this.var_118)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_118.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_118[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_295,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_654 * this._floorThicknessMultiplier;
            _loc19_ = _loc18_;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_295,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_295,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_295,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_295,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_248}" height="{this._height}" wallHeight="{this.var_1435}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc4_ = <tileRow/>;
            _loc5_ = this.var_609[_loc2_];
            _loc6_ = 0;
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_135[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1316;
         }
         var _loc2_:RoomPlaneData = this.var_135[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_135[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
