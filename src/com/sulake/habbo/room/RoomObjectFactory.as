package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_945.indexOf(param1) < 0)
         {
            this.var_945.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1181.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_945.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_945.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1181.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1181.getValue(param1) == null)
         {
            this.var_1181.add(param1,true);
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            case RoomObjectLogicEnum.const_1730:
               ...
               break;
            case RoomObjectLogicEnum.const_1758:
            ...
            case RoomObjectLogicEnum.const_352:
               ...
               break;
            case RoomObjectLogicEnum.const_1696:
            ...
            case RoomObjectLogicEnum.const_311:
               ...
               break;
            case RoomObjectLogicEnum.const_1679:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1754.getValue(param1) == null)
            {
               this.var_1754.add(param1,true);
