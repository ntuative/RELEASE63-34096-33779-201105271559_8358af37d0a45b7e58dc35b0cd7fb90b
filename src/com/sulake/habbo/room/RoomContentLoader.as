package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_964:String = "RCL_LOADER_READY";
      
      private static const const_364:String = "RCL_PUBLICROOM_";
      
      private static const const_1961:int = 0;
      
      private static const const_1010:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_449:String = "place_holder";
      
      private static const const_650:String = "wall_place_holder";
      
      private static const const_651:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_449;
      
      private static const const_649:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1013:String = "selection_arrow";
      ...
      private var var_1406:IEventDispatcher = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2316 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2312 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2315 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2314 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_913.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_378.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_416 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_416.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               ...
               if(this.var_347[_loc7_] == null)
               {
                  this.var_347[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_594.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_593.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_593.remove(_loc7_);
               this.var_593.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2313)
         {
            ...
            {
               this.var_1406.dispatchEvent(new Event(const_964));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_499 != null)
         {
            ...
            this.var_499.add(param1,param2);
         }
         if(this.var_498 != null)
         {
            this.var_498.remove(param2);
            this.var_498.add(param2,param1);
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_303;
         }
         return RoomObjectCategoryEnum.const_182;
      }
      ...
      {
         return [const_449,const_650,const_651,const_649,TILE_CURSOR,const_1013];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_417.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_594.getValue(param1) as String;
      ...
      {
         return this.var_913.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_912[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_594.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_200 != null && this.var_200.hasWorldType(const_364 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_238 || param1 == RoomObjectVisualizationEnum.const_55 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_347[_loc4_] == null)
                     {
                        this.var_347[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1405.getValue(param1) != null)
         {
            this.var_200 = this.var_1405.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_864,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2316.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1715);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2312.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_500,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_912.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1405.add(param1,_loc4_);
         this.var_200 = _loc4_;
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_567.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_416.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_416[_loc2_] != null)
         {
            _loc3_ = this.var_416.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_364 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_364 + param1) == RoomObjectCategoryEnum.const_82)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_200.getWorldHeightScale(const_364 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_200 != null)
         {
            return this.var_200.getWorldScale(const_364 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_417.add(param1,param2);
      }
   }
}
