package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_2117:Dictionary;
      ...
      {
         this.var_2117 = new Dictionary();
         this.var_2934 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_2118 = (param2 & 0) > 0;
         if(!this.var_2118)
         {
            lock();
         }
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_2118)
            {
               if("false" == this.var_195.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_185,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_185,this.onLocalizationLoaded);
         if(this.var_195.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_195.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_185,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_185,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_2117[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_2117[param1];
      }
      ...
      {
         return this.var_2934[Math.max(0,param1 - 1)];
      }
