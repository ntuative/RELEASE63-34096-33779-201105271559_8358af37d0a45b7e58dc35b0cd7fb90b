package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1737:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1673:String = "bool";
      ...
      private static const const_668:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_667:String = "value";
      
      private static const const_679:String = "true";
      
      private static const const_1980:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_668));
         }
         else
         {
            _loc4_ = param1.child(const_668)[0];
         }
         ...
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_667));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_667)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_297 || _loc5_ == const_147)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1737:
               return Number(param1);
            case const_38:
               return param1 == const_679 || int(param1) > 0;
            case const_1673:
               return param1 == const_679 || int(param1) > 0;
            case const_144:
               return uint(param1);
            case const_147:
               return param1.split(const_1479);
            default:
