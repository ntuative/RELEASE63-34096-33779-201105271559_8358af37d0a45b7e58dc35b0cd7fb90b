package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_662:Map = new Map();
      
      private static const const_368:Map = new Map();
      
      private static var var_1210:Boolean = false;
      ...
      {
         return const_662.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1210)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_662.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1210 = true;
         }
