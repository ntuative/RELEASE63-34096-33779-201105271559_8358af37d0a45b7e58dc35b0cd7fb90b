package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2170:String = "_INCLUDE";
      
      public static const const_2219:String = "_TEMP";
      
      private static const const_1590:String = "layout";
      
      private static const const_1105:String = "window";
      
      private static const const_1104:String = "variables";
      
      private static const const_1106:String = "filters";
      
      private static const const_447:String = "name";
      
      private static const const_1593:String = "style";
      
      private static const const_680:String = "params";
      
      private static const const_1588:String = "tags";
      ...
      private static const const_1594:String = "visible";
      
      private static const const_1591:String = "caption";
      ...
      private static const const_1583:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1589:String = "treshold";
      
      private static const const_1584:String = "children";
      
      private static const const_1582:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1587:String = "height_min";
      
      private static const const_1586:String = "height_max";
      
      private static const const_679:String = "true";
      
      private static const const_171:String = "0";
      
      private static const const_1595:String = "$";
      
      private static const const_1479:String = ",";
      
      private static const const_51:String = "";
      
      private static const const_1585:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1592:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1378:Dictionary;
      
      protected var var_1379:Dictionary;
      
      protected var var_1108:Dictionary;
      
      protected var var_1644:Dictionary;
      
      protected var var_2190:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1379 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1378,this.var_1379);
         this.var_1108 = new Dictionary();
         this.var_1644 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1108,this.var_1644);
         this.var_2190 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1592,const_51);
         return param1.replace(const_1585,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1378)
            {
               delete this.var_1378[_loc1_];
            }
            for(_loc1_ in this.var_1379)
            {
               delete this.var_1379[_loc1_];
            }
            for(_loc1_ in this.var_1108)
            {
               delete this.var_1108[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1590)
         {
            _loc8_ = param1.child(const_1104);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1106).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1105);
         ...
         if(param1.localName() == const_1105)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1378[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_447,variables,"")));
         style = uint(this.parseAttribute(xml,const_1593,variables,style));
         params = uint(this.parseAttribute(xml,const_680,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1588,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1594,variables,visible.toString()) == const_679;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_680).length() > 0)
         {
            list = xml.child(const_680).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_447,variables,"") as String;
               if(this.var_1108[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_447)) + "\"!");
               }
               params |= this.var_1108[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1591,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1479);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1104)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1582,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1587,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1586,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_679;
         blend = Number(this.parseAttribute(xml,const_1179,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1583,variables,window.clipping.toString()) == const_679;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1589,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1106).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1379[param1.type];
