package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_1549:String = "/*";
      
      private static const const_1548:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_91[const_215],var_91[ITALIC],var_91[BOLD]];
            var_91.reset();
            var_91[const_215] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1549) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1548) + 2,_loc5_.length);
            }
