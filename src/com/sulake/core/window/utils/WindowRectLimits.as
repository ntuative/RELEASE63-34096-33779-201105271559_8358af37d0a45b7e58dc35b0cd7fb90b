package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_322 = param1;
         if(this.var_322 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_322)
         {
      ...
      {
         return this.var_323 == int.MIN_VALUE && this.var_322 == int.MAX_VALUE && this.var_325 == int.MIN_VALUE && this.var_324 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.width > this.var_322)
            {
               this._target.width = this.var_322;
            }
