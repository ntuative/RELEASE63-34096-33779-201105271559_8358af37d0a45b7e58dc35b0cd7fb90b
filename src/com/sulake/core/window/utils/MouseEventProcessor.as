package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_895:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_342 = new Array();
            var_342[0] = MouseCursorType.const_334;
            var_342[1] = MouseCursorType.const_30;
            var_342[2] = MouseCursorType.const_334;
            var_342[3] = MouseCursorType.const_334;
            var_342[4] = MouseCursorType.const_334;
            var_342[5] = MouseCursorType.const_30;
            var_342[6] = MouseCursorType.const_334;
         }
         if(var_292 == null)
         {
            var_292 = new Array();
            var_292[0] = WindowState.const_84;
            var_292[1] = WindowState.const_89;
            var_292[2] = WindowState.const_87;
            var_292[3] = WindowState.const_67;
            var_292[4] = WindowState.const_57;
            var_292[5] = WindowState.const_97;
            var_292[6] = WindowState.const_85;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_67 = state.var_1355 as WindowController;
         this.var_176 = state.var_1356 as WindowController;
         this.var_171 = state.renderer;
         this.var_895 = state.var_1359;
         eventQueue.begin();
         this.var_709.x = -1;
         this.var_709.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_709.x || event.stageY != this.var_709.y)
            {
               ...
               array = new Array();
               this.var_88.groupParameterFilteredChildrenUnderPoint(this.var_709,array,WindowParam.const_31);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_67 && !this.var_67.disposed)
                     {
                        ...
                        {
                           this.var_895.mouseEventReceived(event.type,this.var_67);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1355 = this.var_67;
         state.var_1356 = this.var_176;
         state.renderer = this.var_171;
         state.var_1359 = this.var_895;
      }
