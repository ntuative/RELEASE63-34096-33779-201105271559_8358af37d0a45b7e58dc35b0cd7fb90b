package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2003:String = "_POINTER_UP";
      
      private static const const_2001:String = "_POINTER_DOWN";
      
      private static const const_2002:String = "_POINTER_LEFT";
      
      private static const const_2000:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_734,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
