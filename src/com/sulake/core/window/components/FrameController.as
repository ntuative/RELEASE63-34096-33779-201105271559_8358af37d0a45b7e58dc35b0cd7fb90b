package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1484:String = "_TITLE";
      
      private static const const_1532:String = "_HEADER";
      
      private static const const_1531:String = "_CONTENT";
      
      private static const const_1530:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1543:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1484) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1543 = findChildByTag(const_1532) as IHeaderWindow;
            if(!this.var_1543)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_183 = findChildByTag(const_1531) as IWindowContainer;
            if(!this.var_183)
            {
      ...
      {
         return findChildByTag(const_1530) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1358,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1106 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_306);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_293);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_257,_loc3_.left,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,_loc3_.top,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_273,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         return _loc1_;
      }
