package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_901:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_720:String;
      
      private var var_1114:String = null;
      
      private var var_1662:StyleSheet = null;
      ...
      {
         this.var_720 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1114 == param2)
         {
            return;
         }
         param1.var_1114 = param2;
         param1.var_1662 = null;
         if(param1.var_1114 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1114);
            param1.var_1662 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_935.indexOf(param1) > -1)
         {
            this.var_720 = param1;
         }
      }
      ...
      {
         return this.var_720 == LinkTarget.const_30 ? defaultLinkTarget : this.var_720;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1662;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1284)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_720 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_956,this.var_720,PropertyStruct.const_53,true,PropertyDefaults.const_935));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1940);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_956)
            {
               this.var_720 = _loc2_.value as String;
               break;
            }
