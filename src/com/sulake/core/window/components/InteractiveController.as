package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_560)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_560)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_993,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1946);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1337)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_866,param1.toolTipDelay,PropertyStruct.const_268,true));
         }
         else
         {
      ...
      {
         this.var_1366 = param1 == null ? "null" : param1;
      }
