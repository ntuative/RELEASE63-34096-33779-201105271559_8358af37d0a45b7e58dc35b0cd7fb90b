package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_113 = 0;
         this.var_102 = 0;
         this._horizontal = param2 == WindowType.const_436;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_177 = var_481 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_422,WindowStyle.const_179,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_376,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_131,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_221,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1371;
      }
      ...
      {
         return new Rectangle(this.var_711 * this.maxScrollH,this.var_713 * this.maxScrollV,width,height);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_540,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_517,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_376,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_131,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_221,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_222:
               if(this.var_1373)
               {
                  this.var_1374 = this.var_2185 - _loc3_;
                  this.var_1372 = this.var_2186 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1374 != 0 && this.var_113 != 0)
                     {
                        this.scrollH += this.var_1374 / this.var_113;
                     }
                  }
            ...
            case WindowMouseEvent.const_197:
               if(this.var_1373)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1374,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1105 && !this.var_581 && this._container)
         {
            this.var_581 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_857)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_383,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1130);
         }
         if(this.var_1105 != PropertyDefaults.const_1134)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_950,this.var_1105,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1739);
         }
         if(this.var_486 != PropertyDefaults.const_1345)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_842,this.var_486,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1782);
         }
         if(this.var_1371 != PropertyDefaults.const_1158)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_843,this.var_1371,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1869);
         }
         if(this.var_714 != PropertyDefaults.const_1156)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_908,this.var_714,PropertyStruct.const_118,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1871);
         }
         if(this.var_712 != PropertyDefaults.const_1164)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_887,this.var_712,PropertyStruct.const_118,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_950:
                  this.var_1105 = _loc2_.value as Boolean;
                  break;
