package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1640:uint = 500;
      
      protected var var_1366:String = "";
      
      protected var var_1377:Boolean = false;
      
      protected var var_798:Boolean = false;
      ...
      {
         this.var_1366 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_798 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_208,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_371,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_353,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_699,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1936);
         _loc1_.push(this.var_1377 != PropertyDefaults.const_1304 ? new PropertyStruct(PropertyDefaults.const_865,this.var_1377,PropertyStruct.const_38,true) : PropertyDefaults.const_1798);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1252 ? new PropertyStruct(PropertyDefaults.const_867,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1905);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1350 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1912);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_865:
                  this.var_1377 = _loc2_.value as Boolean;
                  if(this.var_1377)
                  {
               ...
               case PropertyDefaults.const_699:
                  ...
                  break;
               case PropertyDefaults.const_1234:
