package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1282:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_454)
         {
            this.var_454.removeEventListener(WindowEvent.const_275,this.scrollBarEventProc);
            this.var_454.removeEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            this.var_454 = null;
         }
         if(this.var_1282)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1282)
         {
            this.var_1282 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_454)
         {
            ...
            if(this.var_454)
            {
               this.var_454.addEventListener(WindowEvent.const_275,this.scrollBarEventProc);
               this.var_454.addEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            }
         }
         return this.var_454;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_291)
         {
            this.hideScrollBar();
         }
      }
