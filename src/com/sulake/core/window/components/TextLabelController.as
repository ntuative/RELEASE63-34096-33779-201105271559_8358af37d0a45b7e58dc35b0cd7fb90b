package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2639 = _loc2_.textWidth;
         this.var_2638 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_371 != _loc2_.color : this.var_371 != null && this.var_371 != PropertyDefaults.const_770) ? new PropertyStruct(PropertyDefaults.const_406,this.var_371,PropertyStruct.const_144,true) : PropertyDefaults.const_1323);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_797)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_257,this.var_42.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_914);
            }
            if(this.var_42.top != PropertyDefaults.const_877)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,this.var_42.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_815);
            }
            if(this.var_42.right != PropertyDefaults.const_764)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,this.var_42.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_907);
            }
            if(this.var_42.bottom != PropertyDefaults.const_744)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_273,this.var_42.bottom,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_729);
            }
         }
         else
         {
