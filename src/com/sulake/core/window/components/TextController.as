package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1356:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_889:Number;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_427,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_427 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_427,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      {
         this.var_889 = param1;
         this._field.scrollH = this.var_889 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_889 * this.maxScrollH,this.var_577 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_922,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1319));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1266 ? new PropertyStruct(PropertyDefaults.const_712,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1342) : PropertyDefaults.const_1747);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_268,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1215 ? new PropertyStruct(PropertyDefaults.const_1343,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1127) : PropertyDefaults.const_1688);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_770) ? new PropertyStruct(PropertyDefaults.const_406,this._field.textColor,PropertyStruct.const_144,true) : PropertyDefaults.const_1323);
         _loc1_.push(this.var_427 != TextStyleManager.const_215 ? new PropertyStruct(PropertyDefaults.const_377,this.var_427,PropertyStruct.const_53,true,PropertyDefaults.const_876) : PropertyDefaults.const_1144);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_797 ? new PropertyStruct(PropertyDefaults.const_257,this.var_42.left,PropertyStruct.const_41,true) : PropertyDefaults.const_914);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_877 ? new PropertyStruct(PropertyDefaults.const_294,this.var_42.top,PropertyStruct.const_41,true) : PropertyDefaults.const_815);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_764 ? new PropertyStruct(PropertyDefaults.const_237,this.var_42.right,PropertyStruct.const_41,true) : PropertyDefaults.const_907);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_744 ? new PropertyStruct(PropertyDefaults.const_273,this.var_42.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_729);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1235 ? new PropertyStruct(PropertyDefaults.const_992,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1830);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_118,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_118,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_118,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
