package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1427:String = "_SELECTOR";
      
      private static const const_1428:String = "_CONTENT";
       
      
      protected var var_1100:ITabSelectorWindow;
      
      protected var var_2175:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1100 = findChildByTag(const_1427) as ITabSelectorWindow;
            if(this.var_1100 != null)
            {
               this.var_1100.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2175 = findChildByTag(const_1428) as IWindowContainer;
         }
      ...
      {
         return !!this.var_798 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1100.numSelectables;
      }
