package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2059:uint = 64;
      
      public static const const_2054:uint = 128;
      ...
      protected var var_893:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_198:Shape;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_221.numChildren > 0)
               {
                  this.var_221.removeChildAt(0);
               }
            }
            this.var_221 = null;
            while(numChildren > 0)
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_198)
            {
               this.var_198 = new Shape();
               this.var_198.visible = false;
               this.var_198.cacheAsBitmap = true;
               super.addChild(this.var_198);
            }
            this.var_198.graphics.clear();
            this.var_198.graphics.beginFill(255);
            this.var_198.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_198.graphics.endFill();
            this.getDisplayObject().mask = this.var_198;
         }
         else if(this.var_198)
         {
            super.removeChild(this.var_198);
            this.var_198.graphics.clear();
            this.var_198 = null;
         ...
         if(this.var_893)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2176,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2176,16777215);
                  }
                  var_341 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_221 == null)
         {
            this.var_221 = new Sprite();
            this.var_221.name = this.name + " - Child Container";
            this.var_221.mouseEnabled = false;
            addChild(this.var_221);
         }
         return this.var_221;
      }
      ...
      {
         return this.var_221 != null ? int(this.var_221.numChildren) : 0;
      }
