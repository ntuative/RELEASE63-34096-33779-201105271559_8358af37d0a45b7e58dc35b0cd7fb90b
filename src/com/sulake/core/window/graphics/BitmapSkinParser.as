   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_334 = SkinLayoutEntity.const_605;
                  break;
               case "move":
                  _loc5_.var_334 = SkinLayoutEntity.const_357;
                  break;
               case "strech":
                  _loc5_.var_334 = SkinLayoutEntity.const_597;
                  break;
               case "tiled":
                  _loc5_.var_334 = SkinLayoutEntity.const_321;
                  break;
               case "center":
                  _loc5_.var_334 = SkinLayoutEntity.const_522;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_335 = SkinLayoutEntity.const_605;
                  break;
               case "move":
                  _loc5_.var_335 = SkinLayoutEntity.const_357;
                  break;
               case "strech":
                  _loc5_.var_335 = SkinLayoutEntity.const_597;
                  break;
               case "tiled":
                  _loc5_.var_335 = SkinLayoutEntity.const_321;
                  break;
               case "center":
                  _loc5_.var_335 = SkinLayoutEntity.const_522;
            }
         }
