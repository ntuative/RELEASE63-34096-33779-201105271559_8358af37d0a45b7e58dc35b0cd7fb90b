package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1036:uint = 8;
      
      private static const const_1438:String = "skin";
      
      private static const const_1439:String = "bitmap";
      
      private static const const_1441:String = "fill";
      
      private static const const_1442:String = "text";
      
      private static const const_1440:String = "label";
      ...
      private var var_2502:Dictionary;
      
      private var var_2504:Dictionary;
      
      private var var_2503:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_953 = new Dictionary();
         this.var_1783 = new Dictionary();
         this.var_2502 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1783,this.var_2502);
         this.var_2504 = new Dictionary();
         this.var_2503 = new Dictionary();
         StateCodeTable.fillTables(this.var_2504,this.var_2503);
         this.var_432 = new Dictionary();
         this.var_432[const_1438] = BitmapSkinRenderer;
         this.var_432[const_1439] = BitmapDataRenderer;
         this.var_432[const_1441] = FillSkinRenderer;
         this.var_432[const_1442] = TextSkinRenderer;
         this.var_432[const_1440] = LabelRenderer;
         this.var_432[const_1443] = ShapeSkinRenderer;
         this.var_432[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_432[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_340 == null)
         {
            var_340 = new Array();
            var_340.push(WindowState.const_67);
            var_340.push(WindowState.const_85);
            var_340.push(WindowState.const_97);
            var_340.push(WindowState.const_57);
            var_340.push(WindowState.const_87);
            var_340.push(WindowState.const_89);
            var_340.push(WindowState.const_84);
            var_340.push(WindowState.const_100);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2947 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1783[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_954[param1] == null)
         {
            this.var_954[param1] = new Array(const_1036);
         }
         this.var_954[param1][param2] = param3;
         if(this.var_953[param1] == null)
         {
            this.var_953[param1] = new Array(const_1036);
         }
         this.var_953[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_954[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_953[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_179)
