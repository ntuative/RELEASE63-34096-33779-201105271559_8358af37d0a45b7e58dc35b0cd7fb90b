   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_539 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_110 is BitmapDataAsset)
         {
            ...
            this.var_1560 = BitmapDataAsset(this.var_110).var_1560;
            this.var_1559 = BitmapDataAsset(this.var_110).var_1559;
            if(this._bitmap != null)
            {
               this.var_110 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1560 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1559 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
