package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1103 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1110 = new LoaderContext();
         this.var_1110.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1110);
         }
      }
      ...
      {
         this.var_1103 = param1.url;
         var_337 = 0;
         this.var_43.load(param1,this.var_1110);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_337 < var_2961)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1103 + (this.var_1103.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_337),this.var_1110);
               return true;
            }
         }
         return false;
