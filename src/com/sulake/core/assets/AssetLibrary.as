package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1324:String = "AssetLibraryReady";
      
      public static const const_864:String = "AssetLibraryLoaded";
      
      public static const const_1780:String = "AssetLibraryUnloaded";
      
      public static const const_1664:String = "AssetLibraryLoadError";
      
      private static const const_447:String = "name";
      
      private static const const_1097:String = "asset";
      
      private static const const_1096:String = "param";
      ...
      private static var var_2015:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_554:uint = 0;
      
      private static var var_1037:Array = new Array();
      ...
      private var var_457:uint;
      
      private var var_43:LibraryLoader;
      
      private var var_667:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_1040 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1097);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_447);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1096);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1037.splice(var_1037.indexOf(this),1);
            --var_554;
            this.var_555 = null;
            this.var_1040 = null;
            this.var_168 = null;
      ...
      {
         if(this.var_668 == param1.url && this.var_1039)
         {
            if(!this.var_1038 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_667);
            }
            this.var_1038 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1324));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1040)
         {
            delete this.var_1040[_loc1_];
         }
         if(this.var_43 != null)
         {
            this.var_43.dispose();
      ...
      {
         var _loc2_:Class = this.var_1040[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1297,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1239,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_457;
                     this.var_458.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_458.length ? this.getAssetByName(this.var_458[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_168)
         {
            ...
            {
               return this.var_458.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_168[param1] != null || (this.var_667 != null ? this.var_667[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2015.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_168)
            {
               if(this.var_168[_loc2_] == param1)
               {
                  this.var_458.splice(this.var_458.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_459.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_459[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_459[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_459)
         {
            _loc3_ = AssetTypeDeclaration(this.var_459[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_459)
         {
            _loc4_ = AssetTypeDeclaration(this.var_459[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_1039 = true;
         dispatchEvent(new Event(AssetLibrary.const_864));
         dispatchEvent(new Event(AssetLibrary.const_1324));
         if(this.var_1038)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1664));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1097);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_447).toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_667[param1]);
                  _loc6_ = _loc3_.child(const_1096);
                  if(_loc6_.length())
                  {
