package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2068:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1173:uint = 4;
       
      
      protected var var_868:uint = 0;
      
      protected var var_1360:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1360 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1360);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1612 & const_1173)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_868 + "]";
      }
