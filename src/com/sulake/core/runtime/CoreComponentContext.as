package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1627:String = "asset-libraries";
      
      private static const const_1631:String = "library";
      
      private static const const_1632:String = "service-libraries";
      
      private static const const_1630:String = "library";
      
      private static const const_1625:String = "component-libraries";
      
      private static const const_1624:String = "library";
      
      private static const const_1626:String = "error_data";
      
      private static const const_1628:String = "error_cat";
      
      private static const const_1629:String = "error_desc";
       
      
      private var var_399:LibraryLoaderQueue;
      
      private var var_866:IEventDispatcher;
      
      private var var_566:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_713:
               ...
               var_408.addChild(new ProfilerViewer(this.var_215));
               break;
            case Core.const_531:
      ...
      {
         return this.var_566 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_283[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1626,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1628,String(param3));
         ErrorReportStorage.setParameter(const_1629,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         if(this.var_399 == null)
         {
            this.var_399 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1627)[0];
            if(node != null)
            {
               list = node.child(const_1631);
         ...
         try
         {
            node = config.child(const_1632)[0];
            if(node != null)
            {
               list = node.child(const_1630);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         try
         {
            node = config.child(const_1625)[0];
            if(node != null)
            {
               list = node.child(const_1624);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1125);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_866)
                  {
                     this.var_866.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_566 - this.var_399.length,this.var_566,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_215 ? 0 : this.var_1612 & 0;
         if(_loc3_ == Core.const_531)
         {
            this.var_283[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_283[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_215 ? 0 : this.var_1612 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_104)
         {
            _loc3_ = this.var_283[_loc5_] as Array;
            if(_loc4_ == Core.const_531)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_691[priority] = 0;
            receivers = this.var_283[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_104)
         {
            ...
            {
               if(this.var_691[priority] < priority)
               {
                  ++this.var_691[priority];
                  skip = true;
               }
            }
            if(!skip)
