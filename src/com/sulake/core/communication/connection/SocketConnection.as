package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1922:int = 10000;
      ...
      private var var_562:ByteArray;
      
      private var var_1323:IEncryption;
      
      private var var_856:IProtocol;
      
      private var _id:String;
      
      private var var_1324:IMessageClassManager;
      
      private var var_257:ICoreCommunicationManager;
      
      private var var_561:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_257 = param2;
         this.var_562 = new ByteArray();
         this.var_1324 = new MessageClassManager();
         this.var_82 = new Socket();
         this.var_212 = new Timer(const_1922,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_561)
         {
            this.var_561.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_212.start();
         this.var_855 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1324.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_561)
         {
            this.var_561.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1323 != null)
         {
            _loc3_ = this.var_1323.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1324.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1323 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_856.getMessages(this.var_562,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_561)
               {
                  this.var_561.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1324.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_562,offset);
               this.var_562 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_562.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_562.writeByte(this.var_82.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_212.stop();
         this.var_2046 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_855));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2046 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_855));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_855));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_855));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_855));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_855));
