   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_279 != null)
         {
            ...
            {
               _loc3_ = this.var_279.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1404.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_678.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_678[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_279.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_279.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_279.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_279.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
