package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1141:int = 2;
      ...
      private var var_3025:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_500,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_847,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_694 == null || this.var_567 == null)
         {
            return;
         }
         this._state = const_1736;
         if(this.var_1335 != null)
         {
            _loc1_ = this.var_1335;
            this.var_1335 = null;
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_678.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_678[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_567.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_567.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_1078.indexOf(_loc2_) < 0)
         {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_1078[0];
            this.var_1078.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_567 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_567.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_567.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
