package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1703 || param1.getUpdateID() != this.var_2656)
         {
            this.var_2656 = param1.getUpdateID();
            if(param2.updateId != this.var_1703 || _loc4_.x != this.var_1255.x || _loc4_.y != this.var_1255.y || _loc4_.z != this.var_1255.z)
            {
               this.var_1703 = param2.updateId;
               this.var_1255.assign(_loc4_);
               _loc3_ = true;
            }
         }
