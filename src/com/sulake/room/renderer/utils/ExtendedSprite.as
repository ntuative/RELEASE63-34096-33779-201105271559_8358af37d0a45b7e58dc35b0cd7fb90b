package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1574:int = 128;
      
      private var var_1573:Boolean = false;
      
      private var var_2996:Point;
      ...
      {
         if(param1 != this.var_2012 || param2 != this.var_2013)
         {
      ...
      {
         if(this.var_1574 > 255 || bitmapData == null)
         {
            return false;
         }
