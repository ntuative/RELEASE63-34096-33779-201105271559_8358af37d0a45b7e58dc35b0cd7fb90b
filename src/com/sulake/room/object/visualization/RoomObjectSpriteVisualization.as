package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_354:IRoomObject;
      
      private var var_793:IGraphicAssetCollection;
      
      protected var var_484:int = -1;
      
      protected var var_153:int = -1;
      
      protected var var_95:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_206 != null)
         {
            ...
            {
               _loc1_ = this.var_206[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_793.removeReference();
         }
         this.var_793 = param1;
         if(this.var_793 != null)
         {
            this.var_793.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_206.length > param1)
         {
            _loc2_ = this.var_206[this.var_206.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
