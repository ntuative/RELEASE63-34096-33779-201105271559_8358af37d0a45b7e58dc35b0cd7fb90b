package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_354:IRoomObjectController;
      ...
      {
         if(this.var_354 == param1)
         {
            return;
         }
         if(this.var_354 != null)
         {
            this.var_354.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_354 = param1;
            this.var_354.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_354 != null)
            {
               this.var_354.setLocation(param1.loc);
               this.var_354.setDirection(param1.dir);
            }
         }
      }
